...
% --- BACKUP B2 ---
\begin{frame}{BACKUP B2.1: Thuật toán Chấm Điểm — Phân loại 3 tầng (Triage)}
...
% --- BACKUP B4 ---
\begin{frame}{BACKUP B4.1: Sơ đồ CSDL — Các bảng chính}
...
\end{frame}
% --- BACKUP B6 ---
\begin{frame}{BACKUP B6.1: Cơ chế Scanner \& Trust Score (Crowdsourcing)}
...
% --- BACKUP B7 ---
\begin{frame}[fragile]{BACKUP B7.1: Luồng xác thực \& Đồng bộ Frontend}
