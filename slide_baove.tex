    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{tikzpicture}[>=Stealth, node distance=0.25cm,
                ...
                \node[box, below=of n5, fill=NutriGreen!20] (n6) {\textbf{Giới hạn 0--100, phân loại \& gán nhãn}};
        ...
        \begin{column}{0.44\textwidth}
            ...
            \begin{tikzpicture}[>=Stealth, node distance=0.3cm,
                ...
                \node[box, below=of warn, fill=NutriGreen!20] (score) {Daily Health Score\\(Điểm sức khỏe trong ngày)};
                \draw[arrow] (log) -- (cmp);
                \draw[arrow] (cmp) -- (warn);
