...
\begin{frame}{BACKUP B3.2: Ý nghĩa của trọng số $\alpha$ trong EMA}
    ...
    \begin{itemize}
        ...
        \vspace{0.2cm}
        \item \textcolor{NutriGreen!80!black}{\textbf{Chọn $\alpha = 0.1$ là mức cân bằng hoàn hảo:}} Giúp lọc bỏ hoàn toàn các dao động ảo hàng ngày (như nước dư, thức ăn chưa tiêu hóa), nhưng vẫn theo sát được xu hướng tăng/giảm cân thực sự của cơ thể qua các tuần.
    \end{itemize}
\end{frame}
