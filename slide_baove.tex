...
\begin{frame}{Adaptive TDEE – Điều chỉnh theo dữ liệu thực tế}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                \item \scriptsize \textbf{Định nghĩa:} EMA (Exponential Moving Average – Trung bình trượt hàm mũ) là phương pháp làm mượt chuỗi dữ liệu theo thời gian, trong đó dữ liệu mới được gán trọng số lớn hơn và ảnh hưởng của dữ liệu cũ giảm dần theo hàm mũ.
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item \scriptsize Tránh làm mượt kép: Dùng $\text{TDEE}_{\text{thô}}$ để tính.
    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Cộng/Trừ điểm:} Dựa trên Protein, Xơ (+), Sodium, Đường (-).
                \item \textbf{Vi chất:} Thưởng tối đa +10đ/vi chất (Vitamin A, C, Canxi, Sắt).
                \item \textbf{Giới hạn trần:} Vi chất quá kém $\rightarrow$ trần 50; Thiếu xơ $\rightarrow$ trần 60.
                \item \textbf{Tổng hợp 7/30 ngày:} Phân tích \& xuất báo cáo Top thực phẩm tốt/xấu nhất.
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.44\textwidth}
            ...
            \vspace{0.1cm}
            \begin{itemize}
                \item Điểm cơ sở = \textbf{100} (thang 0--100).
                \item \textbf{Phân loại 3 tầng:} $< 50\%$ calo $\rightarrow$ mute vi chất; $\geq 70\%$ $\rightarrow$ đầy đủ.
                \item \textbf{Nhận biết ngữ cảnh:} Chỉ báo thiếu hụt rõ ràng khi $\geq$ 20h.
                \item \textbf{Cơ chế Penalty \& Multiplier:} Phạt biến thiên theo tỷ lệ thiếu hụt/vượt ngưỡng.
                \item \textbf{Giới hạn trần:} Thiếu vi chất $\rightarrow$ trần 50; Thiếu xơ $\rightarrow$ trần 60.
                \item \textbf{Tổng hợp 7/30 ngày:} Theo dõi xu hướng \& trung bình điểm sức khỏe.
            \end{itemize}
        \end{column}
    \end{columns}
    \vspace{0.3cm}
