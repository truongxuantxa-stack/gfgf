    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                ...
                \Large
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b1}{\textbf{B1. Toán học Meal Planner}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b2}{\textbf{B2. Chấm điểm \& Hàm phạt}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b3}{\textbf{B3. Adaptive TDEE \& EMA}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b4}{\textbf{B4. Sơ đồ CSDL}}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                \setlength\itemsep{0.8cm}
                \Large
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b5}{\textbf{B5. Food Scoring \& Habit}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b6}{\textbf{B6. Trust Score Scanner}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b7}{\textbf{B7. Luồng Auth Frontend}}
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\setbeamertemplate{footline}{
  ...
  \begin{beamercolorbox}[wd=.5\paperwidth,ht=2.25ex,dp=1ex,left]{}%
    \hspace*{2ex}\hyperlink{backup_toc}{\textcolor{NutriDark}{\textbf{$\hookleftarrow$ Quay lại Mục lục Backup}}}
  \end{beamercolorbox}%
