    ...
    \begin{columns}[T]
        \begin{column}{0.52\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Giới hạn trần (Hard Cap):} Vi chất quá kém $\rightarrow$ trần 50; Thiếu xơ $\rightarrow$ trần 60.
            \end{itemize}
        \end{column}
        ...
        \begin{column}{0.44\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Phân loại 3 tầng (Triage):} $< 50\%$ calo $\rightarrow$ mute vi chất; $\geq 70\%$ $\rightarrow$ đầy đủ.
                \item \textbf{Nhận biết ngữ cảnh (Context):} Chỉ báo thiếu hụt khi $\geq$ 20h.
                \item \textbf{Cơ chế Penalty:} Danger $-15$đ, nhân hệ số lệch ($\times 0.5 \rightarrow 2.5$).
                \item \textbf{Hệ số trượt (Multiplier):} Calo $< 30\% \rightarrow \times 0.3$; Đường $> 200\%$ AHA $\rightarrow \times 0.7$.
                \item \textbf{Giới hạn trần (Hard Cap):} Thiếu vi chất $\rightarrow$ trần 50; Thiếu xơ $\rightarrow$ trần 60.
            \end{itemize}
        \end{column}
    \end{columns}
    \vspace{0.3cm}
