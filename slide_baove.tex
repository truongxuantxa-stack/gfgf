...
\begin{frame}{Kiến trúc tổng thể của hệ thống}
    ...
    \begin{tikzpicture}[>=Stealth, node distance=0.6cm and 0.4cm,
        ...
        \node[layer, below left=1cm and -1.8cm of api] (router) {Router};
        \node[layer, right=0.2cm of router] (controller) {Controller};
        \node[layer, right=0.2cm of controller] (service) {Service};
        \node[layer, right=0.2cm of service] (model) {Sequelize Model};
