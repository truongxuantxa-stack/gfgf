    ...
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                ...
                \Large
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b1_target}{\textbf{B1. Toán học Meal Planner}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b2_target}{\textbf{B2. Chấm điểm \& Hàm phạt}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b3_target}{\textbf{B3. Adaptive TDEE \& EMA}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b4_target}{\textbf{B4. Sơ đồ CSDL}}
            \end{itemize}
        \end{column}
        \begin{column}{0.45\textwidth}
            \begin{itemize}
                \setlength\itemsep{0.8cm}
                \Large
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b5_target}{\textbf{B5. Food Scoring \& Habit}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b6_target}{\textbf{B6. Trust Score Scanner}}
                \item[\textcolor{NutriDark}{$\blacktriangleright$}] \hyperlink{b7_target}{\textbf{B7. Luồng Auth Frontend}}
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{BACKUP B1.3: Ưu điểm của phương pháp Khử Gauss}
    ...
    \begin{itemize}
        \item \textbf{Tốc độ cực nhanh (Thời gian hằng số):} Với số ẩn cố định $n = 3$, độ phức tạp $O(n^3)$ thực chất trở thành $O(1)$, chi phí giải hệ rất nhỏ.
        \vspace{0.2cm}
...
\begin{frame}{BACKUP B1.4: Xử lý ngoại lệ (Edge Cases)}
    ...
    \begin{itemize}
        \small
        \item \textbf{Nghiệm âm} ($w_i < 0$) hoặc khối lượng quá bất thường: Đánh dấu là \textbf{Error} (Lỗi).
...
\hypertarget{b4_target}{}
    ...
    \begin{tabular}{lll}
        ...
        \textbf{MealTemplate} & Cấu trúc bữa ăn & Lưu tỷ lệ macro cho bữa ăn \\
        \textbf{UserMealConfig} & Cấu hình bữa ăn & Liên kết User với MealTemplate \\
...
\hypertarget{b7_target}{}
    ...
    \begin{itemize}
        \item Quản lý bộ nhớ đệm (cache) phía client, tự động \texttt{invalidateQueries} sau mỗi \texttt{mutation} (thêm/sửa/xóa) để giao diện luôn đồng bộ.
    \end{itemize}
\end{frame}
