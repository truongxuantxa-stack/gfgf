...
\begin{frame}[label=backup_toc]{Mục lục Backup (Q\&A)}
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \hyperlink{b1}{\beamerbutton{B1. Toán học Meal Planner}} \\[0.3cm]
            \hyperlink{b2}{\beamerbutton{B2. Chấm điểm \& Hàm phạt}} \\[0.3cm]
            \hyperlink{b3}{\beamerbutton{B3. Adaptive TDEE \& EMA}} \\[0.3cm]
            \hyperlink{b4}{\beamerbutton{B4. Sơ đồ CSDL}}
        \end{column}
        \begin{column}{0.5\textwidth}
            \hyperlink{b5}{\beamerbutton{B5. Food Scoring \& Habit}} \\[0.3cm]
            \hyperlink{b6}{\beamerbutton{B6. Trust Score Scanner}} \\[0.3cm]
            \hyperlink{b7}{\beamerbutton{B7. Luồng xác thực Frontend}}
        \end{column}
    \end{columns}
\end{frame}
...
\addtobeamertemplate{footline}{}{%
  \begin{tikzpicture}[remember picture,overlay]
    \node[anchor=south east, xshift=-0.5cm, yshift=0.5cm] at (current page.south east) {\hyperlink{backup_toc}{\beamerreturnbutton{Quay lại mục lục}}};
  \end{tikzpicture}%
}
