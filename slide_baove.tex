...
\begin{frame}{Meal Planner – Tính khẩu phần bằng phương pháp khử Gauss}
    ...
    \begin{columns}[T]
        \begin{column}{0.46\textwidth}
            ...
            \begin{itemize}
                \item \scriptsize Nghiệm âm $\rightarrow$ Lỗi (error).
                \item \scriptsize $<10$g (trừ fat), $>500$g (trừ rau) $\rightarrow$ Cảnh báo (warning).
                \item \scriptsize Retry tối đa 15 lần, chọn phương án ít lỗi error nhất.
            \end{itemize}
        \end{column}
...
\begin{frame}{Kết quả thực nghiệm và kiểm thử}
    ...
    \begin{center}
        ...
        \begin{tabularx}{0.98\textwidth}{>{\hsize=0.28\hsize}X | >{\hsize=0.72\hsize}X}
            ...
            Adaptive TDEE & Kịch bản 7 ngày: TDEE tĩnh 2500 $\rightarrow$ Adaptive TDEE 2200 kcal (−12\%); phát hiện plateau và đề xuất mục tiêu 1700 kcal. \\
