...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        process/.style={rectangle, draw, rounded corners, text width=3.5cm, align=center, minimum height=1.2cm, fill=blue!5},
        ...
        % Cột phải
        \node (n6) [process, right=of n5] {6. Trừ macro rau khỏi mục tiêu};
        \node (n7) [process, above=of n6] {7. Lập hệ phương trình 3x3};
        \node (n8) [process, above=of n7] {8. Giải bằng khử Gauss};
        \node (n9) [decision, above=0.5cm of n8] {9. Kiểm tra nghiệm};
        \node (n10) [process, fill=green!10, above=0.5cm of n9] {10. Trả về khẩu phần};
        
        % Nút Smart Swap
        \node (n11) [process, fill=red!10, right=1.2cm of n8] {Smart Swap\\(Thay nguyên liệu)};
        ...
        \draw [arrow] (n9) -| node[above, pos=0.25] {Không} (n11);
        \draw [arrow] (n11) |- (n7);
