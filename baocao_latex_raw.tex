...
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm chức năng} & \textbf{Mô tả yêu cầu} \\ \hline
FR-01 & Quản lý tài khoản & Đăng ký, đăng nhập, đăng xuất và duy trì trạng thái xác thực \\ \hline
FR-02 & Hồ sơ sức khỏe & Khởi tạo và cập nhật thông tin cá nhân phục vụ tính toán dinh dưỡng \\ \hline
FR-03 & Nhật ký ăn uống & Ghi nhận thực phẩm theo bữa và lưu giá trị dinh dưỡng tại thời điểm nhập liệu \\ \hline
FR-04 & Nước uống & Ghi nhận lượng nước uống trong ngày và theo dõi tiến độ so với mục tiêu \\ \hline
FR-05 & Cân nặng và luyện tập & Theo dõi cân nặng, hoạt động vận động và năng lượng tiêu hao \\ \hline
FR-06 & Thực phẩm & Tìm kiếm, quản lý và bổ sung dữ liệu thực phẩm \\ \hline
FR-07 & Tính toán và phân tích & Tính BMI, BMR, TDEE, Adaptive TDEE, Food Scoring và Health Insights \\ \hline
FR-08 & Meal Planner & Xây dựng thực đơn gợi ý dựa trên mục tiêu dinh dưỡng \\ \hline
FR-09 & Hybrid Nutrition Scanner & Tra cứu mã vạch và nhận dạng bảng thành phần dinh dưỡng từ hình ảnh \\ \hline
FR-10 & Dashboard và báo cáo & Hiển thị dữ liệu tổng hợp, biểu đồ, nhận xét và xuất báo cáo PDF \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm yêu cầu} & \textbf{Nội dung} \\ \hline
NFR-01 & Bảo mật & Kiểm soát quyền truy cập API bằng Access Token và hỗ trợ duy trì phiên bằng Refresh Token \\ \hline
NFR-02 & Nhất quán dữ liệu & Dữ liệu được gắn với người dùng, có ràng buộc quan hệ và lưu snapshot dinh dưỡng khi cần \\ \hline
NFR-03 & Khả năng sử dụng & Giao diện rõ ràng, hỗ trợ thao tác nhập liệu, hiển thị trạng thái xử lý và thông báo lỗi \\ \hline
NFR-04 & Hiệu năng & Đảm bảo thời gian phản hồi phù hợp cho các chức năng thường xuyên sử dụng \\ \hline
NFR-05 & Khả năng mở rộng & Kiến trúc phân lớp, tách biệt Frontend, Backend, Service, Model và cơ sở dữ liệu \\ \hline
NFR-06 & Tích hợp bên ngoài & Xử lý và chuẩn hóa dữ liệu từ Open Food Facts API và Gemini AI Vision \\ \hline
NFR-07 & Bảo trì & Mã nguồn được tổ chức theo module, component và service để thuận lợi cho kiểm thử và mở rộng \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Nghiệp vụ} & \textbf{Dữ liệu đầu vào} & \textbf{Xử lý chính} & \textbf{Kết quả đầu ra} \\ \hline
Đăng ký, đăng nhập & Họ tên, email, mật khẩu & Kiểm tra tài khoản, xác thực thông tin, cấp Access Token và Refresh Token & Người dùng được xác thực và truy cập hệ thống \\ \hline
Khởi tạo hồ sơ sức khỏe & Giới tính, tuổi, chiều cao, cân nặng, mức độ vận động, mục tiêu & Lưu hồ sơ, tính BMI, BMR, TDEE, mục tiêu năng lượng, macro và nước & Hồ sơ sức khỏe được khởi tạo, người dùng được chuyển vào hệ thống chính \\ \hline
Ghi nhật ký ăn uống & Thực phẩm, khẩu phần, bữa ăn, ngày ghi nhận & Tính dinh dưỡng theo khẩu phần, lưu bản ghi nhật ký và dữ liệu snapshot & Nhật ký ăn uống và tổng dinh dưỡng trong ngày được cập nhật \\ \hline
Ghi nhận nước uống & Lượng nước uống, ngày ghi nhận & Lưu dữ liệu nước uống, tổng hợp theo ngày & Tiến độ nước uống được cập nhật trên Dashboard \\ \hline
Theo dõi cân nặng & Cân nặng, ngày ghi nhận & Lưu lịch sử cân nặng, cập nhật biểu đồ và xu hướng & Dữ liệu cân nặng được dùng cho theo dõi và Adaptive TDEE \\ \hline
Ghi nhận luyện tập & Hoạt động, thời lượng hoặc năng lượng tiêu hao & Lưu dữ liệu luyện tập, tổng hợp năng lượng tiêu hao & Dữ liệu vận động được hiển thị trên Dashboard và báo cáo \\ \hline
Hybrid Nutrition Scanner & Mã vạch hoặc ảnh bảng thành phần dinh dưỡng & Tra cứu dữ liệu nội bộ, gọi Open Food Facts hoặc AI Vision, chuẩn hóa kết quả & Thông tin sản phẩm được trả về để ghi nhật ký hoặc đóng góp dữ liệu \\ \hline
Xem Dashboard & Ngày xem, dữ liệu người dùng & Tổng hợp hồ sơ, nhật ký, nước uống, cân nặng, luyện tập và phân tích & Các chỉ số tổng hợp và nhận xét được hiển thị \\ \hline
Xây dựng thực đơn & Mục tiêu dinh dưỡng, bữa ăn, mẫu bữa, dữ liệu thực phẩm & Tính toán khẩu phần thực phẩm theo mục tiêu & Thực đơn gợi ý được tạo và có thể dùng cho nhật ký ăn uống \\ \hline
Xuất báo cáo PDF & Khoảng thời gian cần báo cáo & Tổng hợp dữ liệu hồ sơ, nhật ký, cân nặng, luyện tập, nước uống và phân tích & File PDF báo cáo được tạo \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Thành phần} & \textbf{Loại} & \textbf{Vai trò} \\ \hline
Người dùng & Tác nhân chính & Sử dụng các chức năng quản lý dinh dưỡng cá nhân \\ \hline
Open Food Facts API & Hệ thống bên ngoài & Cung cấp dữ liệu sản phẩm theo mã vạch khi cơ sở dữ liệu nội bộ chưa có dữ liệu phù hợp \\ \hline
Gemini AI Vision & Hệ thống bên ngoài & Hỗ trợ nhận dạng bảng thành phần dinh dưỡng từ hình ảnh \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
\textbf{Mã Use Case} & \textbf{Tên Use Case} & \textbf{Tác nhân} & \textbf{Mô tả} \\ \hline
UC01 & Đăng ký tài khoản & Người dùng & Tạo tài khoản mới để sử dụng hệ thống \\ \hline
UC02 & Đăng nhập & Người dùng & Xác thực tài khoản và truy cập hệ thống \\ \hline
UC03 & Khởi tạo và cập nhật hồ sơ sức khỏe & Người dùng & Khai báo hoặc chỉnh sửa thông tin phục vụ tính toán dinh dưỡng \\ \hline
UC04 & Ghi nhật ký ăn uống & Người dùng & Thêm thực phẩm đã sử dụng vào nhật ký theo từng bữa \\ \hline
UC05 & Ghi nhận nước uống & Người dùng & Ghi nhận lượng nước uống trong ngày và theo dõi tiến độ so với mục tiêu \\ \hline
UC06 & Tìm kiếm thực phẩm & Người dùng & Tìm kiếm thực phẩm trong cơ sở dữ liệu để ghi nhật ký hoặc xây dựng thực đơn \\ \hline
UC07 & Theo dõi cân nặng & Người dùng & Ghi nhận cân nặng theo thời gian \\ \hline
UC08 & Ghi nhận luyện tập & Người dùng & Lưu thông tin hoạt động vận động và năng lượng tiêu hao \\ \hline
UC09 & Xem Dashboard & Người dùng & Xem các chỉ số tổng hợp, biểu đồ và nhận xét phân tích \\ \hline
UC10 & Xây dựng thực đơn & Người dùng & Nhận gợi ý thực đơn dựa trên mục tiêu dinh dưỡng \\ \hline
UC11 & Quét mã vạch sản phẩm & Người dùng & Tra cứu thông tin sản phẩm đóng gói theo mã vạch \\ \hline
UC12 & Nhận dạng bảng thành phần dinh dưỡng & Người dùng & Trích xuất thông tin dinh dưỡng từ ảnh bảng thành phần \\ \hline
UC13 & Xuất báo cáo PDF & Người dùng & Tạo báo cáo tổng hợp dữ liệu dinh dưỡng theo khoảng thời gian \\ \hline
\end{tabular}
\end{table}
...
Luồng chính & Nhập thông tin đăng nhập, gửi yêu cầu, xác thực tài khoản, cấp Access Token và Refresh Token, điều hướng theo trạng thái hồ sơ \\ \hline
Luồng thay thế & Email hoặc mật khẩu không hợp lệ, hệ thống trả thông báo lỗi \\ \hline
Hậu điều kiện & Người dùng được xác thực và có thể truy cập các chức năng phù hợp \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\ \hline
Tên Use Case & Ghi nhật ký ăn uống \\ \hline
Tác nhân & Người dùng \\ \hline
Tiền điều kiện & Người dùng đã đăng nhập và có dữ liệu thực phẩm phù hợp \\ \hline
Luồng chính & Chọn thực phẩm, nhập khẩu phần, chọn bữa ăn, xác nhận thêm vào nhật ký, hệ thống tính toán và lưu dữ liệu \\ \hline
Luồng thay thế & Không tìm thấy thực phẩm phù hợp, người dùng tìm kiếm lại hoặc sử dụng Scanner \\ \hline
Hậu điều kiện & Nhật ký ăn uống được cập nhật và tổng dinh dưỡng trong ngày được tính lại \\ \hline
\textbf{c. Use Case sử dụng Hybrid Nutrition Scanner} & Use Case sử dụng Hybrid Nutrition Scanner hỗ trợ người dùng nhập dữ liệu đối với thực phẩm đóng gói. Người dùng có thể quét mã vạch sản phẩm hoặc chụp ảnh bảng thành phần dinh dưỡng. \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\ \hline
Tên Use Case & Sử dụng Hybrid Nutrition Scanner \\ \hline
Tác nhân & Người dùng \\ \hline
Hệ thống liên quan & Open Food Facts API, Gemini AI Vision \\ \hline
Tiền điều kiện & Người dùng đã đăng nhập \\ \hline
Luồng chính & Quét mã vạch hoặc gửi ảnh, hệ thống tìm kiếm dữ liệu nội bộ, gọi dịch vụ bên ngoài nếu cần, chuẩn hóa kết quả và trả về giao diện \\ \hline
Luồng thay thế & Không tìm thấy sản phẩm hoặc ảnh không đủ dữ liệu, hệ thống thông báo để người dùng nhập lại hoặc bổ sung thủ công \\ \hline
Hậu điều kiện & Dữ liệu sản phẩm được trả về, lưu trữ hoặc sử dụng để ghi nhật ký \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Nhóm dữ liệu} & \textbf{Một số bảng chính} & \textbf{Vai trò} \\ \hline
Người dùng và hồ sơ & User & Lưu tài khoản, hồ sơ sức khỏe và cấu hình cá nhân \\ \hline
Thực phẩm & Food & Lưu dữ liệu dinh dưỡng của thực phẩm \\ \hline
Nhật ký ăn uống & DiaryEntry & Lưu thực phẩm người dùng đã sử dụng theo ngày và bữa \\ \hline
Theo dõi sức khỏe & WeightLog, WaterLog, ExerciseLog & Lưu cân nặng, nước uống và luyện tập \\ \hline
Meal Planner & MealTemplate, UserMealConfig & Lưu mẫu bữa ăn và cấu hình phân bổ bữa ăn \\ \hline
Adaptive TDEE & AdaptiveTDEELog & Lưu lịch sử tính toán TDEE thích ứng \\ \hline
Scanner & ScannedProduct, ProductContribution & Lưu sản phẩm quét và dữ liệu đóng góp \\ \hline
\end{tabular}
\end{table}
...
success & Trạng thái xử lý thành công hoặc thất bại \\ \hline
data & Dữ liệu trả về khi xử lý thành công \\ \hline
message & Thông báo kết quả hoặc lỗi \\ \hline
errors & Danh sách lỗi chi tiết khi dữ liệu đầu vào không hợp lệ \\ \hline
\textbf{2.5.3. Thiết kế xác thực API}Các API của hệ thống được chia thành hai nhóm: API công khai và API yêu cầu xác thực. & API công khai bao gồm đăng ký, đăng nhập, đăng xuất và làm mới Access Token. Đây là các API cần được truy cập trước khi người dùng có trạng thái xác thực hợp lệ hoặc trong quá trình duy trì phiên đăng nhập. \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Nhóm API} & \textbf{Đường dẫn chính} & \textbf{Vai trò} \\ \hline
Auth & /api/v1/auth & Đăng ký, đăng nhập, đăng xuất, làm mới Token, lấy thông tin người dùng hiện tại \\ \hline
Dashboard & /api/v1/dashboard & Lấy dữ liệu tổng hợp phục vụ Dashboard \\ \hline
Diary & /api/v1/diary & Quản lý nhật ký ăn uống và thực phẩm tùy chỉnh \\ \hline
Profile & /api/v1/profile & Quản lý hồ sơ sức khỏe, macro, dị ứng và onboarding \\ \hline
Weight & /api/v1/weight & Quản lý dữ liệu cân nặng \\ \hline
Water & /api/v1/water & Quản lý dữ liệu nước uống \\ \hline
Exercise & /api/v1/exercise & Quản lý dữ liệu luyện tập \\ \hline
Meal Planner & /api/v1/meal-planner & Cấu hình bữa ăn, lấy nguyên liệu, sinh thực đơn và thay thế nguyên liệu \\ \hline
Adaptive TDEE & /api/v1/adaptive-tdee & Quản lý trạng thái và lịch sử tính toán Adaptive TDEE \\ \hline
Scanner & /api/v1/scanner & Quét mã vạch, nhận dạng bảng thành phần và lưu dữ liệu sản phẩm \\ \hline
Report & /api/v1/report & Xuất báo cáo PDF \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
\textbf{Nhóm API} & \textbf{Phương thức} & \textbf{Endpoint} & \textbf{Mô tả} \\ \hline
Auth & POST & /api/v1/auth/register & Đăng ký tài khoản mới \\ \hline
Auth & POST & /api/v1/auth/login & Đăng nhập và nhận Access Token \\ \hline
Auth & POST & /api/v1/auth/refresh-token & Làm mới Access Token \\ \hline
Dashboard & GET & /api/v1/dashboard?date=YYYY-MM-DD & Lấy dữ liệu tổng hợp cho Dashboard theo ngày \\ \hline
Diary & GET & /api/v1/diary & Lấy nhật ký ăn uống theo ngày \\ \hline
Diary & POST & /api/v1/diary/entries & Thêm thực phẩm vào nhật ký \\ \hline
Diary & GET & /api/v1/diary/foods/search & Tìm kiếm thực phẩm \\ \hline
Profile & POST & /api/v1/profile/onboarding & Lưu thông tin khởi tạo hồ sơ \\ \hline
Profile & PUT & /api/v1/profile/macros & Cập nhật cấu hình macro \\ \hline
Weight & POST & /api/v1/weight & Thêm bản ghi cân nặng \\ \hline
Water & POST & /api/v1/water & Ghi nhận lượng nước uống \\ \hline
Exercise & POST & /api/v1/exercise & Thêm hoạt động luyện tập \\ \hline
Meal Planner & POST & /api/v1/meal-planner/generate & Sinh gợi ý thực đơn \\ \hline
Adaptive TDEE & GET & /api/v1/adaptive-tdee/status & Lấy trạng thái Adaptive TDEE \\ \hline
Scanner & POST & /api/v1/scanner/barcode-lookup & Tra cứu sản phẩm theo mã vạch \\ \hline
Scanner & POST & /api/v1/scanner/ai-vision & Nhận dạng bảng thành phần dinh dưỡng từ ảnh \\ \hline
Scanner & POST & /api/v1/scanner/confirm-contribution & Xác nhận và lưu dữ liệu sản phẩm đóng góp \\ \hline
Report & GET & /api/v1/report/pdf?range=week & Xuất báo cáo PDF theo tuần \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Mã trạng thái} & \textbf{Ý nghĩa} \\ \hline
200 & Xử lý thành công \\ \hline
201 & Tạo mới dữ liệu thành công \\ \hline
400 & Dữ liệu yêu cầu không hợp lệ \\ \hline
401 & Chưa xác thực hoặc Token không hợp lệ \\ \hline
403 & Không có quyền thực hiện thao tác \\ \hline
404 & Không tìm thấy tài nguyên hoặc endpoint tương ứng \\ \hline
409 & Xung đột dữ liệu \\ \hline
422 & Lỗi kiểm tra dữ liệu đầu vào \\ \hline
429 & Vượt quá giới hạn số lượng yêu cầu \\ \hline
500 & Lỗi máy chủ \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Màn hình} & \textbf{Vai trò} & \textbf{Thành phần chính} \\ \hline
Onboarding & Khởi tạo hồ sơ sức khỏe ban đầu cho người dùng & Biểu mẫu thông tin cá nhân, chiều cao, cân nặng, mức độ vận động, mục tiêu cá nhân \\ \hline
Theo dõi cân nặng & Lưu và hiển thị lịch sử cân nặng của người dùng & Biểu đồ cân nặng, danh sách bản ghi, biểu mẫu thêm cân nặng \\ \hline
Luyện tập & Ghi nhận hoạt động vận động và năng lượng tiêu hao & Danh sách hoạt động, biểu mẫu thêm luyện tập, thông tin năng lượng tiêu hao \\ \hline
Hồ sơ cá nhân & Cập nhật thông tin cơ thể, mục tiêu và cấu hình dinh dưỡng & Thông tin cá nhân, cấu hình macro, mục tiêu nước, thông tin dị ứng hoặc loại trừ thực phẩm \\ \hline
Xuất báo cáo PDF & Tổng hợp dữ liệu dinh dưỡng theo tuần hoặc tháng & Tùy chọn khoảng thời gian, nút xuất báo cáo, trạng thái tải file \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Nhóm API} & \textbf{Vai trò chính} \\ \hline
/api/v1/auth & Đăng ký, đăng nhập, đăng xuất, làm mới token \\ \hline
/api/v1/profile & Quản lý hồ sơ cá nhân và mục tiêu dinh dưỡng \\ \hline
/api/v1/dashboard & Tổng hợp dữ liệu dinh dưỡng, nước uống, vận động và cân nặng \\ \hline
/api/v1/diary & Quản lý nhật ký ăn uống và thực phẩm người dùng \\ \hline
/api/v1/weight, /water, /exercise & Ghi nhận cân nặng, nước uống và vận động \\ \hline
/api/v1/meal-planner & Cấu hình và tạo kế hoạch bữa ăn \\ \hline
/api/v1/adaptive-tdee & Theo dõi và cập nhật TDEE thích ứng \\ \hline
/api/v1/scanner & Xử lý mã vạch, ảnh nhãn dinh dưỡng và dữ liệu sản phẩm \\ \hline
/api/v1/report & Tổng hợp dữ liệu và xuất báo cáo PDF \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[box, fill=orange!5] (auth) at (4.8, 0) {Auth Context\\(Quản lý Đăng nhập)};
        \node[box, fill=cyan!5] (reactquery) at (4.8, -2.4) {TanStack Query\\(State \& Cache)};
        
        \node[box, fill=purple!5] (axios) at (9.6, -2.4) {Axios Instance\\(HTTP Client)};
        \node[smbox, fill=gray!15] (localstorage) at (9.6, -0.8) {localStorage};
        \node[smbox, fill=red!10] (toaster) at (9.6, 0.6) {react-hot-toast\\(Global Error)};
        
        \node[db] (backend) at (13.6, -2.4) {Backend API\\(Express)};
        ...
        % Router <-> Auth Context
        \draw[arrow] ([yshift=2mm]router.east) -- node[above, font=\scriptsize] {Gọi \texttt{useAuth()}} ([yshift=2mm]auth.west);
        \draw[arrow] ([yshift=-2mm]auth.west) -- node[below, font=\scriptsize, align=center] {user,\\isAuthenticated} ([yshift=-2mm]router.east);
        ...
        \draw[dashed_arrow, orange] (axios.north west) to[out=135, in=180] node[left, font=\scriptsize, align=center] {Báo lỗi\\Global} (toaster.west);
        
        % Axios <-> Backend
        \draw[arrow] ([yshift=5mm]axios.east) -- node[above, font=\scriptsize] {HTTP Request} ([yshift=5mm]backend.west);
        \draw[arrow] (backend.west) -- node[below, font=\scriptsize, pos=0.4] {JSON Response} (axios.east);
        \draw[dashed_arrow, red] ([yshift=-5mm]backend.west) -- node[below, font=\scriptsize, pos=0.6] {Lỗi 401} ([yshift=-5mm]axios.east);
...
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Thành phần} & \textbf{Vai trò triển khai} \\ \hline
App.jsx & Khai báo provider, router và cấu trúc route chính của ứng dụng \\ \hline
AuthContext & Quản lý trạng thái đăng nhập và thông tin người dùng \\ \hline
ProtectedRoute & Chặn truy cập vào màn hình nghiệp vụ khi chưa đăng nhập hoặc chưa onboarding \\ \hline
AuthOnlyRoute & Cho phép người dùng đã đăng nhập truy cập trang onboarding \\ \hline
Custom hooks & Đóng gói logic gọi API và xử lý dữ liệu theo từng module \\ \hline
Axios & Gửi HTTP request đến Backend API \\ \hline
TanStack Query & Quản lý dữ liệu server, cache, trạng thái tải và cập nhật lại query \\ \hline
Components & Hiển thị giao diện và xử lý tương tác tại từng màn hình \\ \hline
\end{tabular}
\end{table}
...
\textbf{3.2.5. Liên kết Frontend với Backend}Các màn hình Frontend được triển khai bám theo các module nghiệp vụ của hệ thống. Tuy nhiên, dữ liệu không được truyền trực tiếp giữa các màn hình mà được đồng bộ th        \node (step2) [process, below=0.7cm of step1] {2. Lấy mục tiêu từ Nutrition Core};
        ...
        % Excess — cùng y với step2, cùng x với low
        \node (excess) [process, fill=red!10] at (low |- step2) {Đánh giá THẬA\\(Mọi lúc)};
        
        % Left Column
        \node (crit)    [process, left=1.6cm of triage]  {Tầng Sinh Tồn\\(Bỏ qua THIẾU)};
        \node (def_off) [process, left=1.6cm of context] {Bỏ qua THIẾU\\(Chưa đủ đ.kiện)};y từ server, Axios thực hiện request HTTP, còn các component đảm nhiệm hiển thị và tương tác cụ thể. Các thuật toán dinh dưỡng không được trình bày chi tiết trong mục này vì phần lớn được xử lý ở Backend và sẽ được phân tích ở các mục tiếp theo của Chương 3.
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Dữ liệu đầu vào} & \textbf{Vai trò trong xử lý} & \textbf{Kết quả phụ thuộc} \\ \hline
Cân nặng & Tính BMI, BMR và mục tiêu nước & BMI, BMR, waterGoal \\ \hline
Chiều cao & Tính BMI và BMR & BMI, BMR \\ \hline
Giới tính & Chọn công thức BMR tương ứng & BMR \\ \hline
Ngày sinh & Tính tuổi người dùng & BMR \\ \hline
Mức độ vận động & Chọn hệ số vận động & TDEE \\ \hline
Mục tiêu cá nhân & Điều chỉnh năng lượng nạp vào & targetCalories \\ \hline
Tỷ lệ macro tùy chỉnh & Phân bổ năng lượng sang gram & protein, carbs, fat \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Nhóm dữ liệu} & \textbf{Nguồn dữ liệu} & \textbf{Vai trò trong thuật toán} \\ \hline
Nhật ký ăn uống & Các bản ghi món ăn theo ngày & Tính năng lượng nạp trung bình trong tuần \\ \hline
Cân nặng & Các bản ghi cân nặng theo ngày & Xác định cân nặng đầu tuần, cuối tuần và mức thay đổi \\ \hline
Hồ sơ người dùng & Thông tin cá nhân và mục tiêu & Tính TDEE tĩnh, targetCalories và xác định mục tiêu hiện tại \\ \hline
Trạng thái cấu hình & useAdaptiveTDEE & Quyết định có áp dụng Adaptive TDEE vào các chỉ số hay không \\ \hline
Lịch sử Adaptive TDEE & Bảng log theo tuần & Tính rolling TDEE và theo dõi các lần tính trước \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Trạng thái} & \textbf{Ý nghĩa} & \textbf{Ảnh hưởng} \\ \hline
applied & Dữ liệu đủ điều kiện và kết quả nằm trong biên cho phép & Có thể dùng để tính rolling TDEE \\ \hline
clamped & Kết quả vượt biên và đã được giới hạn lại & Có thể dùng nhưng đã qua bước kiểm soát biên \\ \hline
skipped\_low\_data & Thiếu nhật ký ăn uống hoặc thiếu dữ liệu cân nặng & Không cập nhật User.adaptiveTDEE \\ \hline
skipped\_by\_user & Người dùng chủ động bỏ qua tuần đó & Không tính lại tuần đã bỏ qua \\ \hline
\textbf{b. Công thức tính TDEE thích ứng theo tuần} & Phần cốt lõi của Adaptive TDEE là ước lượng TDEE theo tuần từ năng lượng nạp trung bình và biến động cân nặng. Trong phạm vi triển khai của hệ thống, TDEE tuần được tính theo công thức: & \textbf{TDEE tuần = năng lượng nạp trung bình - biến động cân nặng × 1100} \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node (step2) [process, below=0.6cm of step1] {2. Lấy mục tiêu từ Nutrition Core};
        
        \node (triage) [decision, below=0.8cm of step2] {3. Triage mức calo};
        \node (adeq) [process, below=0.8cm of triage] {Tầng Vi Lượng\\(Check toàn bộ)};
        
        \node (context) [decision, below=0.8cm of adeq] {4. Ngữ cảnh thời gian};
        \node (def_on) [process, fill=green!10, below=0.8cm of context] {Đánh giá THIẾU};
        
        % Merge node before step 5
        \node (merge) [merge, below=0.7cm of def_on] {Hội tụ kết quả};
        
        \node (insight) [process, below=0.6cm of merge] {5. Tạo insight theo severity};
        \node (score) [process, below=0.6cm of insight] {6. Tính điểm sức khỏe};
        \node (dashboard) [process, below=0.6cm of score] {7. Trả về Dashboard};
        
        % Right Column
        \node (low) [process, right=0.6cm of triage] {Tầng Đa Lượng\\(Chỉ check Macro)};
        \node (excess) [process, fill=red!10, right=0.6cm of low, yshift=1.4cm] {Đánh giá THỪA\\(Mọi lúc)};
        
        % Left Column
        \node (crit) [process, left=0.6cm of triage] {Tầng Sinh Tồn\\(Bỏ qua THIẾU)};
        \node (def_off) [process, left=0.6cm of context] {Bỏ qua THIẾU\\(Chưa đủ đ.kiện)};
...
\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
\textbf{Tầng xử lý} & \textbf{Nguồn dữ liệu} & \textbf{Điều kiện sử dụng} & \textbf{Kết quả} \\ \hline
Local Verified & Cơ sở dữ liệu cục bộ & Sản phẩm đã xác thực, điểm tin cậy đạt ngưỡng & Trả sản phẩm ngay \\ \hline
Local Unverified & Dữ liệu cộng đồng & Sản phẩm có dữ liệu nhưng chưa xác thực đầy đủ & Trả sản phẩm kèm trạng thái tin cậy \\ \hline
Open Food Facts API & API bên ngoài & Local DB không có kết quả phù hợp & Lấy dữ liệu và lưu lại vào Local DB \\ \hline
AI Vision Fallback & Ảnh nhãn dinh dưỡng & Không tìm thấy bằng mã vạch & Trích xuất dữ liệu từ ảnh \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Cơ chế} & \textbf{Vai trò} & \textbf{Cách triển khai} \\ \hline
Access Token & Xác thực request cần đăng nhập & Gửi trong header Authorization \\ \hline
Refresh Token & Làm mới phiên đăng nhập & Lưu trong HttpOnly Cookie \\ \hline
requireAuthApi & Bảo vệ API nghiệp vụ & Kiểm tra token trước khi vào controller \\ \hline
bcrypt & Bảo vệ mật khẩu người dùng & Băm mật khẩu trước khi lưu \\ \hline
Rate limit & Hạn chế request bất thường & Giới hạn login/register theo IP \\ \hline
AI Vision rate limit & Hạn chế gửi ảnh quá nhiều & Giới hạn request scanner theo người dùng \\ \hline
Response helper & Chuẩn hóa phản hồi API & Dùng res.success, res.error, res.validationError \\ \hline
Error handler & Xử lý lỗi chưa bắt & Ghi log và trả lỗi máy chủ nội bộ \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Thành phần} & \textbf{Công nghệ/Công cụ sử dụng} & \textbf{Vai trò trong thực nghiệm} \\ \hline
Hệ điều hành & Windows 10/11 & Môi trường chạy ứng dụng và công cụ phát triển \\ \hline
Trình soạn thảo & Visual Studio Code & Chỉnh sửa và quản lý mã nguồn \\ \hline
Backend & Node.js, Express & Cung cấp API và xử lý nghiệp vụ phía máy chủ \\ \hline
Cơ sở dữ liệu & MySQL, Sequelize ORM & Lưu trữ và truy vấn dữ liệu hệ thống \\ \hline
Frontend & React, Vite & Xây dựng giao diện và điều hướng chức năng \\ \hline
Giao tiếp API & Axios, JSON & Trao đổi dữ liệu giữa frontend và backend \\ \hline
Quản lý dữ liệu giao diện & TanStack Query & Lấy dữ liệu, cập nhật cache và đồng bộ trạng thái \\ \hline
Xác thực & JWT, refresh token, cookie HttpOnly & Kiểm tra các chức năng yêu cầu đăng nhập \\ \hline
Sinh báo cáo & PDFKit & Kiểm tra chức năng tạo báo cáo PDF \\ \hline
Kiểm thử API & Postman/Developer Tools & Gửi request và quan sát phản hồi API \\ \hline
Kiểm thử giao diện & Chrome/Edge & Thao tác trực tiếp với các chức năng hệ thống \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
\textbf{Nhóm chức năng} & \textbf{Trường hợp kiểm thử} & \textbf{Kết quả cần đạt} & \textbf{Trạng thái} \\ \hline
Xác thực tài khoản & Đăng ký và đăng nhập bằng thông tin hợp lệ & Hệ thống trả về thông tin người dùng, access token và thiết lập phiên đăng nhập & Đạt \\ \hline
Xác thực tài khoản & Đăng nhập bằng email hoặc mật khẩu sai & Hệ thống từ chối đăng nhập và trả về thông báo lỗi & Đạt \\ \hline
Bảo vệ API & Gọi API yêu cầu đăng nhập nhưng không gửi access token hợp lệ & Hệ thống không cho phép truy cập tài nguyên được bảo vệ & Đạt \\ \hline
Hồ sơ người dùng & Thiết lập giới tính, ngày sinh, chiều cao, cân nặng, mức độ vận động và mục tiêu & Hồ sơ được lưu, trạng thái onboarding được cập nhật & Đạt \\ \hline
Dashboard & Lấy dữ liệu tổng quan theo ngày & Hệ thống trả về tổng năng lượng, chất dinh dưỡng chính, nước uống, luyện tập và chỉ số liên quan & Đạt \\ \hline
Nhật ký dinh dưỡng & Thêm hoặc xóa món ăn theo ngày, bữa ăn và khẩu phần & Bản ghi được cập nhật, tổng dinh dưỡng trong ngày được tính lại & Đạt \\ \hline
Thực phẩm cá nhân & Tạo, sửa hoặc xóa món ăn do người dùng tự nhập & Hệ thống chỉ xử lý dữ liệu thuộc người dùng hiện tại & Đạt \\ \hline
Nước uống và luyện tập & Ghi nhận lượng nước uống, mục tiêu nước và hoạt động luyện tập & Dữ liệu được lưu, tổng lượng nước hoặc năng lượng tiêu hao được cập nhật & Đạt \\ \hline
Cân nặng & Ghi nhận cân nặng hợp lệ, dữ liệu ngoài khoảng cho phép hoặc ngày trong tương lai & Dữ liệu hợp lệ được lưu; dữ liệu không hợp lệ bị từ chối & Đạt \\ \hline
Meal Planner & Sinh gợi ý bữa ăn và thay thế nguyên liệu & Hệ thống trả về danh sách nguyên liệu, khẩu phần và giá trị dinh dưỡng ước tính & Đạt \\ \hline
Scanner & Tra cứu barcode hoặc xử lý ảnh thông tin dinh dưỡng & Hệ thống trả về thông tin sản phẩm hoặc yêu cầu xác nhận khi dữ liệu chưa đủ chắc chắn & Đạt \\ \hline
Báo cáo PDF & Xuất báo cáo theo khoảng thời gian tuần hoặc tháng & File PDF được sinh từ dữ liệu người dùng và trả về cho trình duyệt & Đạt \\ \hline
Xử lý lỗi & Gửi dữ liệu sai, thiếu token, gọi sai endpoint hoặc gửi request vượt giới hạn & Hệ thống trả về phản hồi lỗi dạng JSON và không ghi dữ liệu không hợp lệ & Đạt \\ \hline
\end{tabular}
\end{table}
...
Đối với nhóm hồ sơ người dùng, kiểm thử tập trung vào luồng onboarding và cập nhật thông tin cá nhân. Người dùng cần cung cấp các thông tin cơ bản như giới tính, ngày sinh, chiều cao, cân nặng, mức độ vận động và mục tiêu (chi tiết được minh họa trong Hình \ref{fig:onboarding_tdee}). Đây là các dữ liệu đầu vào cần thiết để hệ thống tính BMI, BMR, TDEE, mục tiêu năng lượng và mục tiêu nước. Khi dữ liệu hợp lệ, thông tin được lưu vào cơ sở dữ liệu và trạng thái hoàn thành onboarding được chuyển sang true. Khi dữ liệu nằm ngoài khoảng cho phép, hệ thống trả về thông báo lỗi và không cập nhật bản ghi.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.32\textwidth]{images/screencapture-localhost-5173-onboarding-2026-07-09-21_34_41.png}\hfill
    \includegraphics[width=0.32\textwidth]{images/screencapture-localhost-5173-onboarding-2026-07-09-21_35_01.png}\hfill
    \includegraphics[width=0.32\textwidth]{images/screencapture-localhost-5173-onboarding-2026-07-09-21_35_20.png}
    \caption{Màn hình Onboarding / Tính TDEE}
    \label{fig:onboarding_tdee}
\end{figure}
...
\begin{tabular}{|p{3cm}|p{4cm}|p{4cm}|p{4cm}|}
\hline
\textbf{Thuật toán} & \textbf{Dữ liệu đầu vào} & \textbf{Kết quả cần kiểm tra} & \textbf{Kết quả thực nghiệm} \\ \hline
Nutrition Core & Hồ sơ người dùng, mức độ vận động, mục tiêu & Tính BMI, BMR, TDEE, macro và mục tiêu nước & Trả về đủ các chỉ số nền tảng cho Dashboard, Profile, Meal Planner và PDF Report \\ \hline
Adaptive TDEE & Năng lượng nạp vào và cân nặng theo tuần & Ước lượng TDEE từ dữ liệu thực tế & Tính được TDEE theo tuần và có giới hạn khi dữ liệu vượt ngưỡng cho phép \\ \hline
Food Scoring & Năng lượng, protein, carbohydrate, chất béo, chất xơ, đường, natri & Chấm điểm chất lượng món ăn & Điểm thay đổi theo mật độ protein, chất xơ, đường và natri \\ \hline
Health Insights & Tổng năng lượng, macro, nước uống, luyện tập & Sinh cảnh báo hoặc gợi ý theo ngưỡng & Tạo được cảnh báo thiếu nước, thiếu protein, dư năng lượng hoặc mất cân đối macro \\ \hline
Meal Planner & Mục tiêu năng lượng, macro và cấu hình bữa ăn & Sinh khẩu phần phù hợp với mục tiêu & Trả về nguyên liệu, khẩu phần ước tính và tổng dinh dưỡng của bữa ăn \\ \hline
Hybrid Nutrition Scanner & Barcode hoặc ảnh nhãn dinh dưỡng & Trích xuất và chuẩn hóa dữ liệu sản phẩm & Trả về sản phẩm hợp lệ hoặc yêu cầu xác nhận khi dữ liệu chưa đủ điều kiện \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{5.5cm}|p{5.5cm}|}
\hline
\textbf{Tiêu chí đánh giá} & \textbf{Kết quả ghi nhận} & \textbf{Nhận xét} \\ \hline
Tính đầy đủ chức năng & Các nhóm chức năng chính đã được triển khai và kiểm thử & Đáp ứng phạm vi chức năng của đồ án \\ \hline
Tính nhất quán dữ liệu & Dữ liệu nhật ký, dashboard, thuật toán và báo cáo có liên kết với nhau & Hạn chế sai khác giữa các màn hình chức năng \\ \hline
Phản hồi API & API trả về dữ liệu và lỗi theo cấu trúc JSON thống nhất & Thuận lợi cho frontend xử lý và hiển thị \\ \hline
Kết quả thuật toán & Các thuật toán chính trả về kết quả theo dữ liệu đầu vào & Phù hợp với mục tiêu hỗ trợ theo dõi dinh dưỡng cá nhân \\ \hline
Xuất báo cáo & Báo cáo PDF tổng hợp được dữ liệu trong phạm vi 7 ngày và 30 ngày & Phù hợp cho chức năng xem lại quá trình theo dõi \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Hạn chế hiện tại} & \textbf{Hướng phát triển} \\ \hline
Dữ liệu thực nghiệm chủ yếu được kiểm tra trên môi trường cục bộ & Triển khai thử nghiệm trên môi trường máy chủ và kiểm tra với nhiều tài khoản người dùng \\ \hline
Cơ sở dữ liệu thực phẩm và sản phẩm đóng gói còn phụ thuộc vào dữ liệu nhập sẵn & Mở rộng nguồn dữ liệu thực phẩm và bổ sung cơ chế kiểm duyệt dữ liệu do người dùng đóng góp \\ \hline
Kết quả Adaptive TDEE phụ thuộc vào nhật ký cân nặng và năng lượng nhiều ngày & Bổ sung cơ chế nhắc nhập dữ liệu và đánh giá độ tin cậy của từng giai đoạn theo dõi \\ \hline
Meal Planner đã có loại trừ dị ứng và ghim nguyên liệu, nhưng còn phụ thuộc vào dữ liệu nguyên liệu và mẫu bữa ăn & Mở rộng mẫu bữa ăn, bổ sung ràng buộc về khẩu vị, ngân sách, thời gian chuẩn bị và mục tiêu theo từng giai đoạn \\ \hline
Scanner phụ thuộc vào chất lượng ảnh, barcode và thông tin trên nhãn sản phẩm & Cải thiện bước kiểm tra dữ liệu sau nhận dạng và quy trình xác nhận trước khi lưu \\ \hline
Báo cáo PDF mới tập trung vào dữ liệu theo tuần và tháng & Bổ sung biểu đồ xu hướng dài hạn và so sánh giữa các giai đoạn theo dõi \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{4cm}|p{11cm}|}
\hline
\textbf{Nội dung đánh giá} & \textbf{Kết quả tổng quát} \\ \hline
Môi trường thực nghiệm & Hệ thống được kiểm thử trên môi trường cục bộ với backend, frontend và cơ sở dữ liệu \\ \hline
Kiểm thử chức năng & Các chức năng chính có thể thực hiện theo luồng người dùng đã xây dựng \\ \hline
Thực nghiệm thuật toán & Các thuật toán chính trả về kết quả theo dữ liệu đầu vào \\ \hline
Xử lý lỗi & API phản hồi lỗi theo cấu trúc JSON thống nhất \\ \hline
Hạn chế & Kết quả còn phụ thuộc vào dữ liệu đầu vào, phạm vi kiểm thử và chất lượng dữ liệu thực phẩm \\ \hline
\end{tabular}
\end{table}
