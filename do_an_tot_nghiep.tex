...
Gợi ý chèn \textbf{Hình 4.X: Màn hình Dashboard (Tổng quan)}.
...
Gợi ý chèn \textbf{Hình 4.X: Màn hình Hybrid Nutrition Scanner (Quét đồ ăn bằng AI)}.
...
Gợi ý chèn \textbf{Hình 4.X: Màn hình Food Scoring (Chấm điểm thực phẩm)}. Với Health Insights, khi dữ liệu nhật ký trong ngày thay đổi, danh sách cảnh báo cũng thay đổi theo. Các cảnh báo như thiếu nước, thiếu protein, dư năng lượng hoặc mất cân đối macro được sinh ra dựa trên các ngưỡng điều kiện đã định nghĩa trong backend.
