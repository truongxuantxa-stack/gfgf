...
\begin{figure}[htbp]
    ...
    \vspace{0.2cm}
    \small \textit{* Ghi chú: Sơ đồ chỉ thể hiện các bảng trung tâm và quan hệ chính. Đường nét đứt thể hiện quan hệ sử dụng ở mức nghiệp vụ, không nhất thiết là khóa ngoại trực tiếp.}
\end{figure}
...
Chương này cũng đã trình bày các thành phần xử lý cốt lõi và chức năng hỗ trợ nhập liệu của NutriTrack. Mỗi thành phần giải quyết một vấn đề riêng trong quá trình quản lý và phân tích dữ liệu dinh dưỡng.
