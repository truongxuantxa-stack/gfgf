...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        % Backend
        \node[box, fill=orange!10, below=2cm of react] (express) {\textbf{Express}\\(Router / Middleware / Controller)};
        ...
        % Connections
        \draw[arrow] (react) -- node[right, font=\bfseries\fontsize{10pt}{12pt}\selectfont] {Axios gọi RESTful API} (backend_box.north);
