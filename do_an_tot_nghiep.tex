...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[innerbox, below=1cm of layer_service.north] (s1) {Dashboard $|$ Diary $|$ Nutrition Core $|$ Adaptive TDEE};
        \node[innerbox, below=0.2cm of s1] (s2) {Food Scoring $|$ Health Insights $|$ Meal Planner $|$ Scanner};
        \node[innerbox, below=0.2cm of s2] (s3) {Report $|$ Weight $|$ Water $|$ Exercise};
        ...
        \node[innerbox, below=1cm of layer_db.north] (db1) {User / Profile $|$ Food / Product $|$ DiaryEntry};
