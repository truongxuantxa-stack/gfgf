...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        err/.style={thick, -Latex, red!60!black, densely dashed},
        ...
        lerr/.style={font=\scriptsize\sffamily, text=red!60!black, fill=white, inner sep=1.5pt},
    ...
    \node[box, below=of query] (axios)
        ...
        \scriptsize Gắn Bearer token vào header\\
        Interceptor: bắt 401 $\to$ refresh};
    ...
    % ═══════════════ LUỒNG 401 (riêng biệt) ═══════════════
    % MW trả 401 → đi ngang sang Axios
    \draw[err] (mw.west) -- node[lerr, above] {401 JSON} ++(-1.0,0) |- ([yshift=6mm]axios.east);
