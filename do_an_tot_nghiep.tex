...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[box, right=0.5cm of i5] (i6) {Sản phẩm quét\\(ScannedProduct)};
        ...
        \node[widebox, below=0.5cm of mid_title, align=center] (b1) {
            \textbf{RESTful API /api/v1} \\
            \textbf{Middleware xác thực JWT} \\
            \textbf{Controller điều phối yêu cầu}
        };

        \node[widebox, below=0.5cm of b1, text width=12cm] (b2) {
            \textbf{Service xử lý nghiệp vụ:}\\
            - Nutrition Core: BMI, BMR, TDEE, macro, water goal\\
            - Dashboard Service: tổng hợp dữ liệu theo ngày\\
            - Food Scoring: chấm điểm mật độ dinh dưỡng\\
            - Health Insights: phân tích cảnh báo\\
            - Adaptive TDEE: hiệu chỉnh TDEE theo dữ liệu thực tế\\
            - Meal Planner: tạo kế hoạch bữa ăn\\
            - Scanner Service: mã vạch + AI Vision\\
            - PDF Service: xuất báo cáo
        };

        \node[widebox, below=0.5cm of b2, text width=6cm, align=center] (b3) {
            \textbf{Sequelize ORM + MySQL}
        };
        ...
        \node[box, right=0.5cm of o1] (o2) {Tổng hợp Dashboard:\\calo, macro, nước...};
        \node[box, right=0.5cm of o2] (o3) {Đánh giá dinh dưỡng:\\điểm món ăn};
    ...
    \caption{Tổng quan bài toán quản lý dinh dưỡng cá nhân}
