...
\textbf{Ước tính năng lượng luyện tập theo MET.}

Đối với dữ liệu luyện tập, \texttt{exercise.service.js} sử dụng MET (Metabolic Equivalent of Task) để ước tính năng lượng tiêu hao. MET biểu thị tỷ lệ giữa mức chuyển hóa khi thực hiện một hoạt động và mức chuyển hóa khi nghỉ; một MET được quy ước bằng 1~kcal/kg/giờ và xấp xỉ mức tiêu hao khi ngồi yên \cite{paCompendiumWebsite}. Với cân nặng \(m\) tính bằng kg, thời gian luyện tập \(t\) tính bằng phút và giá trị MET của hoạt động là \(MET_s\), hệ thống tính năng lượng tiêu hao theo công thức:

\[
E = MET_s \times m \times \frac{t}{60}
\]

Trong đó, \(E\) là năng lượng tiêu hao ước tính, đơn vị kcal; \(MET_s\) là giá trị \texttt{defaultMet} được lấy từ \texttt{MET\_TABLE}; \(m\) là cân nặng người dùng tính bằng kg; \(t\) là thời gian luyện tập tính bằng phút. Kết quả được làm tròn đến một chữ số thập phân trước khi lưu vào trường \texttt{caloriesBurned} của \texttt{ExerciseLog}.

Compendium of Physical Activities cung cấp hệ thống mã và giá trị MET cho nhiều nhóm hoạt động với các mức cường độ khác nhau \cite{herrmann2024Compendium}. Dựa trên nguồn tham chiếu này, NutriTrack tổ chức \texttt{MET\_TABLE} theo các lựa chọn có ý nghĩa đối với giao diện, trong đó một số hoạt động được tách theo cường độ, còn một số hoạt động sử dụng một giá trị mặc định đại diện. Khi người dùng chưa có cân nặng trong hồ sơ, phiên bản hiện tại tạm sử dụng 60~kg để duy trì phép tính; đây là cơ chế dự phòng của hệ thống, không phải giá trị chuẩn do Compendium quy định.

Các giá trị được sử dụng là standard MET và kết quả chỉ mang tính ước tính. Chi phí năng lượng thực tế còn có thể thay đổi theo tuổi, giới tính, thể trạng, kỹ thuật thực hiện và mức chuyển hóa khi nghỉ của từng người; do đó phép tính không thay thế phương pháp đo trực tiếp năng lượng tiêu hao \cite{paCompendiumCorrectedMets}.
