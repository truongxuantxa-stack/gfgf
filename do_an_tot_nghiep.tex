...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        \node[box, fill=gray!10] (backend) at (19.5, 0) {Backend API\\(Server)};

        % Background highlighting the "Frontend"
        \begin{pgfonlayer}{background}
            \node[rectangle, draw, dashed, fill=blue!2, rounded corners, fit=(comp) (hook) (tanstack) (axios), inner sep=0.5cm] (frontend) {};
