...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        ...
        % Backend
        \node[box, fill=orange!10, below=2.8cm of react] (express) {\textbf{Express}\\(Router / Middleware / Controller)};
        \node[box, fill=orange!10, below=1cm of express] (service) {\textbf{Service}\\(Business Logic: Nutrition Core, Adaptive TDEE, Food Scoring, Health Insights, Meal Planner, Scanner, Report)};
        \node[box, fill=orange!10, below=1cm of service] (sequelize) {\textbf{Sequelize ORM}};
        ...
        % Database
        \node[box, fill=green!10, below=1.5cm of backend_box.south] (mysql) {\textbf{MySQL}\\(Database)};
        ...
        % Connections
        \draw[arrow] (react) -- node[right, pos=0.4, font=\bfseries\fontsize{10pt}{12pt}\selectfont] {Axios gọi RESTful API} (backend_box.north);
