...
Quản lý chế độ dinh dưỡng là một trong những yếu tố quan trọng trong việc duy trì sức khỏe và phòng ngừa các bệnh liên quan đến lối sống. Theo Tổ chức Y tế Thế giới, chế độ ăn uống không lành mạnh, thiếu hoạt động thể chất và thừa cân là những yếu tố nguy cơ có liên quan đến nhiều bệnh không lây nhiễm \cite{who_healthy_lifestyle}. Để xây dựng một chế độ ăn phù hợp, người sử dụng cần theo dõi nhiều thông tin như lượng năng lượng tiêu thụ, thành phần dinh dưỡng của thực phẩm, cân nặng, mức độ hoạt động thể chất và sự thay đổi của các chỉ số sức khỏe theo thời gian. Việc ghi chép và tổng hợp các thông tin này bằng phương pháp thủ công thường mất nhiều thời gian, đồng thời khó đảm bảo tính chính xác khi khối lượng dữ liệu ngày càng tăng.
...
Hình \ref{fig:tong_quan_bai_toan} mô tả các nhóm dữ liệu đầu vào của hệ thống, bao gồm hồ sơ sức khỏe, nhật ký ăn uống, cân nặng, nước uống, luyện tập và dữ liệu quét sản phẩm. Các dữ liệu này được Backend tiếp nhận qua tầng API, xử lý tại các service nghiệp vụ và lưu trữ trong cơ sở dữ liệu MySQL thông qua Sequelize ORM. Kết quả xử lý được sử dụng để tạo ra các chỉ số sức khỏe, dashboard tổng hợp, đánh giá dinh dưỡng, gợi ý thực đơn và báo cáo PDF.
...
Mục tiêu tổng quát của hệ thống là xây dựng một ứng dụng web hỗ trợ người dùng quản lý dinh dưỡng cá nhân thông qua việc ghi nhận dữ liệu, tính toán chỉ số, phân tích kết quả và trình bày thông tin dưới dạng trực quan. Hệ thống không chỉ đóng vai trò như một công cụ ghi nhật ký ăn uống mà còn hỗ trợ người dùng theo dõi mối liên hệ giữa chế độ ăn uống, cân nặng, hoạt động luyện tập và mục tiêu cá nhân.

Trước hết, hệ thống cần hỗ trợ người dùng tạo tài khoản, đăng nhập và quản lý hồ sơ sức khỏe cá nhân. Hồ sơ sức khỏe bao gồm các thông tin cơ bản như giới tính, tuổi hoặc ngày sinh, chiều cao, cân nặng, mức độ vận động và mục tiêu cá nhân. Đây là nhóm dữ liệu nền tảng để hệ thống thực hiện các phép tính như BMI, BMR, TDEE, mục tiêu năng lượng, mục tiêu nước và phân bổ chất đa lượng.

Tiếp theo, hệ thống cần cho phép người dùng ghi nhận dữ liệu hằng ngày, bao gồm nhật ký ăn uống, lượng nước uống, cân nặng và hoạt động luyện tập. Các dữ liệu này được lưu trữ theo thời gian để phục vụ việc tổng hợp, theo dõi xu hướng và đánh giá kết quả thực hiện mục tiêu dinh dưỡng.

Một mục tiêu quan trọng khác là hỗ trợ người dùng nhập liệu thực phẩm thuận tiện hơn. Ngoài việc tìm kiếm thực phẩm trong cơ sở dữ liệu, hệ thống cần hỗ trợ tra cứu sản phẩm đóng gói bằng mã vạch và nhận dạng bảng thành phần dinh dưỡng từ hình ảnh. Cách tiếp cận này giúp giảm thao tác nhập thủ công, đặc biệt trong trường hợp người dùng sử dụng các sản phẩm chưa có sẵn trong cơ sở dữ liệu nội bộ.

Hệ thống cũng cần triển khai các thành phần phân tích nhằm tạo ra thông tin có ý nghĩa từ dữ liệu đã ghi nhận. Các thành phần này bao gồm tính toán nhu cầu năng lượng, điều chỉnh TDEE theo dữ liệu thực tế, đánh giá chất lượng thực phẩm, phân tích tình trạng dinh dưỡng trong ngày và xây dựng gợi ý thực đơn. Kết quả xử lý được hiển thị thông qua Dashboard, biểu đồ, nhận xét và báo cáo PDF.

\subsection{Yêu cầu chức năng}
Dựa trên mục tiêu xây dựng hệ thống, các yêu cầu chức năng được xác định theo từng nhóm nghiệp vụ chính.

Nhóm chức năng đầu tiên là quản lý tài khoản và xác thực người dùng. Hệ thống cần cho phép người dùng đăng ký tài khoản, đăng nhập, đăng xuất và duy trì phiên làm việc trong quá trình sử dụng. Các chức năng liên quan đến dữ liệu cá nhân chỉ được truy cập sau khi người dùng đã xác thực hợp lệ.

Nhóm chức năng thứ hai là quản lý hồ sơ sức khỏe. Người dùng cần có khả năng khởi tạo và cập nhật các thông tin cá nhân phục vụ tính toán dinh dưỡng. Sau khi người dùng cung cấp dữ liệu ban đầu, hệ thống tính toán các chỉ số nền tảng như BMI, BMR, TDEE, mục tiêu năng lượng, mục tiêu nước và tỷ lệ chất đa lượng. Những giá trị này được sử dụng làm cơ sở cho các chức năng theo dõi và phân tích tiếp theo.

Nhóm chức năng thứ ba là ghi nhận dữ liệu hằng ngày. Hệ thống cần hỗ trợ người dùng ghi nhật ký ăn uống theo từng bữa, lưu lượng nước uống, cập nhật cân nặng và ghi nhận hoạt động luyện tập. Đối với nhật ký ăn uống, người dùng có thể chọn thực phẩm, nhập khẩu phần và bữa ăn tương ứng. Hệ thống tính toán giá trị dinh dưỡng dựa trên khẩu phần và lưu lại dữ liệu tại thời điểm ghi nhận.

Nhóm chức năng thứ tư là quản lý và khai thác dữ liệu thực phẩm. Hệ thống cần hỗ trợ tìm kiếm thực phẩm, sử dụng thực phẩm trong nhật ký ăn uống, đồng thời cho phép bổ sung dữ liệu thực phẩm khi cần. Đối với sản phẩm đóng gói, hệ thống hỗ trợ tra cứu bằng mã vạch hoặc nhận dạng bảng thành phần dinh dưỡng từ hình ảnh.

Nhóm chức năng thứ năm là tổng hợp và phân tích dữ liệu. Hệ thống cần tổng hợp dữ liệu từ hồ sơ sức khỏe, nhật ký ăn uống, cân nặng, nước uống và luyện tập để hiển thị trên Dashboard. Ngoài các chỉ số tổng hợp, hệ thống cần có các thành phần đánh giá như Food Scoring, Health Insights và Adaptive TDEE để hỗ trợ người dùng theo dõi quá trình thực hiện mục tiêu.

Nhóm chức năng thứ sáu là xây dựng thực đơn và xuất báo cáo. Meal Planner cần hỗ trợ tạo gợi ý thực đơn dựa trên mục tiêu dinh dưỡng và dữ liệu thực phẩm. Chức năng báo cáo PDF cần tổng hợp dữ liệu theo khoảng thời gian, giúp người dùng xem lại kết quả theo tuần hoặc tháng. Các yêu cầu chức năng của hệ thống được tổng hợp chi tiết trong Bảng \ref{tab:tong_hop_chuc_nang}.
...
Bên cạnh các yêu cầu chức năng, hệ thống cần đáp ứng một số yêu cầu phi chức năng nhằm bảo đảm khả năng sử dụng, bảo mật, tính ổn định và khả năng mở rộng.

Về bảo mật, hệ thống cần kiểm soát quyền truy cập đối với các chức năng liên quan đến dữ liệu cá nhân. Người dùng chỉ được truy cập dữ liệu của chính mình sau khi đăng nhập hợp lệ. Các API nghiệp vụ cần được bảo vệ bằng cơ chế xác thực, hạn chế việc truy cập trái phép vào dữ liệu hồ sơ, nhật ký ăn uống, cân nặng, nước uống, luyện tập và báo cáo.

Về tính nhất quán dữ liệu, các bản ghi phát sinh trong quá trình sử dụng cần được liên kết với người dùng tương ứng. Dữ liệu nhật ký ăn uống cần lưu giá trị dinh dưỡng tại thời điểm ghi nhận để bảo toàn lịch sử theo dõi. Dữ liệu từ nguồn bên ngoài hoặc từ nhận dạng hình ảnh cần được kiểm tra và chuẩn hóa trước khi sử dụng trong hệ thống.

Về khả năng sử dụng, giao diện cần được thiết kế rõ ràng, hỗ trợ các thao tác thường xuyên như thêm thực phẩm, ghi nhận nước uống, cập nhật cân nặng, ghi nhận luyện tập và xem Dashboard. Các trạng thái như đang tải dữ liệu, xử lý thành công, lỗi nhập liệu hoặc không có dữ liệu cần được hiển thị phù hợp để người dùng nắm được kết quả thao tác.

Về hiệu năng, hệ thống cần bảo đảm các chức năng thường xuyên sử dụng có thời gian phản hồi phù hợp, đặc biệt là Dashboard, nhật ký ăn uống, tìm kiếm thực phẩm và ghi nhận dữ liệu hằng ngày. Đối với các chức năng phụ thuộc dịch vụ bên ngoài như tra cứu mã vạch hoặc nhận dạng bảng thành phần dinh dưỡng, hệ thống cần xử lý được trường hợp không tìm thấy dữ liệu, dữ liệu không đầy đủ hoặc dịch vụ bên ngoài phản hồi không ổn định.

Về khả năng bảo trì và mở rộng, hệ thống cần được tổ chức theo kiến trúc phân lớp. Backend cần tách biệt các thành phần định tuyến, kiểm tra xác thực, xử lý yêu cầu, xử lý nghiệp vụ và truy cập cơ sở dữ liệu. Frontend cần được chia thành các trang, component và hook để thuận lợi cho việc tái sử dụng và mở rộng. Cách tổ chức này giúp giảm phụ thuộc giữa các phần của hệ thống và hỗ trợ quá trình phát triển các chức năng mới. Tổng hợp các yêu cầu phi chức năng của hệ thống được liệt kê trong Bảng \ref{tab:tong_hop_phi_chuc_nang}.
...
Từ các mục tiêu và yêu cầu trên, hệ thống cần được xây dựng với kiến trúc rõ ràng, có khả năng quản lý dữ liệu người dùng, xử lý nghiệp vụ dinh dưỡng và hỗ trợ phân tích dữ liệu theo thời gian. Để đáp ứng các yêu cầu này, hệ thống triển khai các thuật toán và cơ chế xử lý dữ liệu phục vụ tính toán nhu cầu năng lượng, điều chỉnh TDEE thích ứng, đánh giá mật độ dinh dưỡng của thực phẩm, phân tích tình trạng dinh dưỡng và hỗ trợ nhập liệu bằng quét mã vạch kết hợp nhận dạng bảng thành phần dinh dưỡng từ hình ảnh. Nội dung chi tiết về công nghệ, kiến trúc và các thành phần triển khai được trình bày trong các mục tiếp theo.
...
Hình \ref{fig:data_access_architecture} mô tả kiến trúc truy cập dữ liệu của hệ thống. Các service nghiệp vụ không truy cập trực tiếp vào cơ sở dữ liệu mà làm việc thông qua các Model do Sequelize ORM quản lý. Sequelize thực hiện ánh xạ giữa Model trong mã nguồn và các bảng trong MySQL, đồng thời hỗ trợ thiết lập quan hệ giữa các Model, thực hiện truy vấn CRUD, quản lý Migration và Seeder. Cách tổ chức này giúp tách biệt logic nghiệp vụ với thao tác lưu trữ dữ liệu, đồng thời hỗ trợ bảo trì và mở rộng cấu trúc dữ liệu trong quá trình phát triển hệ thống.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        outerbox/.style={rectangle, draw=black, rounded corners=4pt, inner sep=0pt, minimum width=14cm, align=center},
        innerbox/.style={rectangle, draw=black, rounded corners=2pt, fill=white, inner sep=6pt, align=center, font=\fontsize{10pt}{12pt}\selectfont},
        layertitle/.style={font=\bfseries\fontsize{12pt}{14pt}\selectfont, anchor=north, yshift=-8pt},
        arrow/.style={-{Stealth[length=3mm]}, thick}
    ]

        % ================= LAYER 1: SERVICE =================
        \node[outerbox, fill=blue!5, minimum height=3.8cm] (layer_service) {};
        \node[layertitle] at (layer_service.north) {SERVICE XỬ LÝ NGHIỆP VỤ};
        
        \node[innerbox, below=1cm of layer_service.north] (s1) {Dashboard $|$ Diary $|$ Weight $|$ Water $|$ Exercise};
        \node[innerbox, below=0.2cm of s1] (s2) {Nutrition Core $|$ Adaptive TDEE $|$ Food Scoring $|$ Health Insights};
        \node[innerbox, below=0.2cm of s2] (s3) {Meal Planner $|$ Scanner $|$ Report};

        % ================= LAYER 2: SEQUELIZE =================
        \node[outerbox, fill=orange!5, minimum height=2.4cm, below=1cm of layer_service] (layer_seq) {};
        \node[layertitle] at (layer_seq.north) {SEQUELIZE ORM};
        
        \node[innerbox, below=1cm of layer_seq.north, xshift=-1.5cm] (seq2) {Association};
        \node[innerbox, right=0.4cm of seq2] (seq3) {Query / CRUD};
        \node[innerbox, left=0.4cm of seq2] (seq1) {Model ánh xạ bảng};
        \node[innerbox, right=0.4cm of seq3, dashed, fill=gray!10] (seq4) {Migration / Seeder};

        % ================= LAYER 3: MYSQL =================
        \node[outerbox, fill=green!5, minimum height=4.6cm, below=1cm of layer_seq] (layer_db) {};
        \node[layertitle] at (layer_db.north) {MYSQL DATABASE};
        
        \node[innerbox, below=1cm of layer_db.north] (db1) {User $|$ Food $|$ DiaryEntry};
        \node[innerbox, below=0.2cm of db1] (db2) {WeightLog $|$ WaterLog $|$ ExerciseLog $|$ AdaptiveTDEELog};
        \node[innerbox, below=0.2cm of db2] (db3) {ScannedProduct $|$ ProductContribution};
        \node[innerbox, below=0.2cm of db3] (db4) {MealTemplate $|$ UserMealConfig};

        % ================= CONNECTIONS =================
        \draw[arrow] (layer_service.south) -- (layer_seq.north);
        \draw[arrow] (layer_seq.south) -- (layer_db.north);
        
    \end{tikzpicture}
    }
    \caption{Kiến trúc truy cập dữ liệu thông qua Sequelize ORM}
...
Ngoài ra, hệ thống còn sử dụng các thư viện hỗ trợ xây dựng biểu đồ thống kê, xuất báo cáo PDF, gửi thư điện tử và xử lý tập tin theo yêu cầu của từng chức năng. Danh sách các công nghệ chính được sử dụng trong hệ thống được liệt kê tại Bảng \ref{tab:cong_nghe_su_dung}.
...
Hình \ref{fig:kientruc_tongthe} mô tả kiến trúc tổng thể của hệ thống theo mô hình Client - Server. Người dùng thao tác trên giao diện React Frontend, các yêu cầu được gửi đến Backend thông qua Axios và RESTful API. Tại Backend, yêu cầu lần lượt được tiếp nhận qua Router, xử lý tại Middleware, điều phối bởi Controller và thực hiện nghiệp vụ tại tầng Service. Tầng Service truy cập cơ sở dữ liệu thông qua Sequelize ORM hoặc gọi các dịch vụ bên ngoài như Open Food Facts API và Gemini AI Vision khi cần thiết. Dữ liệu được lưu trữ trong MySQL và kết quả xử lý được trả về Frontend dưới dạng JSON.
...
Hình \ref{fig:kientruc_frontend} mô tả kiến trúc Frontend của hệ thống. Ứng dụng được tổ chức theo mô hình React SPA, trong đó React Router quản lý điều hướng giữa các trang chức năng. Các route yêu cầu đăng nhập được bảo vệ thông qua ProtectedRoute và Auth Context. Mỗi trang được cấu thành từ nhiều component giao diện nhỏ, còn logic lấy dữ liệu và cập nhật dữ liệu được tách ra các custom hook. TanStack Query được sử dụng để quản lý dữ liệu lấy từ máy chủ, lưu cache và đồng bộ dữ liệu sau các thao tác thêm, sửa hoặc xóa. Axios đảm nhiệm việc gửi yêu cầu HTTP đến RESTful API và xử lý token khi giao tiếp với Backend.
...
Hình \ref{fig:kientruc_backend} mô tả kiến trúc Backend của hệ thống theo mô hình MVC kết hợp tầng Service. Request từ Frontend được tiếp nhận qua Router, đi qua Middleware để xác thực và kiểm tra dữ liệu, sau đó được chuyển đến Controller. Controller chỉ đảm nhiệm vai trò điều phối, trong khi các nghiệp vụ chính như tính toán chỉ số dinh dưỡng, Adaptive TDEE, Food Scoring, Health Insights, Meal Planner, Scanner và xuất báo cáo được xử lý tại tầng Service. Khi cần truy cập dữ liệu, Service làm việc với các Model của Sequelize ORM để đọc và ghi dữ liệu trong MySQL. Đối với chức năng Scanner, Service có thể gọi thêm Open Food Facts API hoặc Gemini AI Vision để hỗ trợ tra cứu và nhận dạng dữ liệu thực phẩm.
...
Hình \ref{fig:kientruc_csdl} trình bày kiến trúc tổng quan cơ sở dữ liệu của hệ thống theo các nhóm bảng chính. Cơ sở dữ liệu được tổ chức xoay quanh bảng người dùng, dữ liệu thực phẩm, nhật ký ăn uống, dữ liệu theo dõi sức khỏe, Meal Planner, Adaptive TDEE và Scanner. Trong phạm vi Chương 1, hình chỉ thể hiện các nhóm dữ liệu ở mức tổng quan nhằm mô tả vai trò lưu trữ của từng nhóm. Thiết kế chi tiết các bảng, khóa chính, khóa ngoại và quan hệ giữa các thực thể được trình bày trong Chương 2 và Phụ lục.
...
Bên cạnh các chức năng ghi nhận dữ liệu, hệ thống cần thực hiện các xử lý tính toán và phân tích như Nutrition Core, Adaptive TDEE, Food Scoring, Health Insights và Meal Planner. Các kết quả xử lý được sử dụng để hiển thị trên Dashboard, hỗ trợ xây dựng thực đơn và xuất báo cáo PDF theo khoảng thời gian. Các yêu cầu chức năng được tổng hợp lại trong Bảng \ref{tab:tong_hop_chuc_nang_2}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|p{7cm}|}
\caption{Tổng hợp yêu cầu chức năng của hệ thống} \label{tab:tong_hop_chuc_nang_2} \\
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm chức năng} & \textbf{Mô tả yêu cầu} \\
\hline
\endfirsthead
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm chức năng} & \textbf{Mô tả yêu cầu} \\
...
FR-01 & Quản lý tài khoản & Đăng ký, đăng nhập, đăng xuất và duy trì trạng thái xác thực \\
\hline
FR-02 & Hồ sơ sức khỏe & Khởi tạo và cập nhật thông tin cá nhân phục vụ tính toán dinh dưỡng \\
\hline
FR-03 & Nhật ký ăn uống & Ghi nhận thực phẩm theo bữa và lưu giá trị dinh dưỡng tại thời điểm nhập liệu \\
\hline
FR-04 & Nước uống & Ghi nhận lượng nước uống trong ngày và theo dõi tiến độ so với mục tiêu \\
\hline
FR-05 & Cân nặng và luyện tập & Theo dõi cân nặng, hoạt động vận động và năng lượng tiêu hao \\
\hline
FR-06 & Thực phẩm & Tìm kiếm, quản lý và bổ sung dữ liệu thực phẩm \\
\hline
FR-07 & Tính toán và phân tích & Tính BMI, BMR, TDEE, Adaptive TDEE, Food Scoring và Health Insights \\
\hline
FR-08 & Meal Planner & Xây dựng thực đơn gợi ý dựa trên mục tiêu dinh dưỡng \\
\hline
FR-09 & Hybrid Nutrition Scanner & Tra cứu mã vạch và nhận dạng bảng thành phần dinh dưỡng từ hình ảnh \\
\hline
FR-10 & Dashboard và báo cáo & Hiển thị dữ liệu tổng hợp, biểu đồ, nhận xét và xuất báo cáo PDF \\
\hline
\end{longtable}
...
Về khả năng mở rộng và bảo trì, hệ thống cần được tổ chức theo kiến trúc phân lớp, tách biệt Frontend, Backend và cơ sở dữ liệu. Backend cần phân tách Router, Middleware, Controller, Service và Model. Frontend cần tổ chức theo trang, component và custom hook để thuận lợi cho việc tái sử dụng và mở rộng chức năng. Các yêu cầu phi chức năng được trình bày tóm tắt trong Bảng \ref{tab:tong_hop_phi_chuc_nang_2}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|p{7cm}|}
\caption{Tổng hợp yêu cầu phi chức năng của hệ thống} \label{tab:tong_hop_phi_chuc_nang_2} \\
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm yêu cầu} & \textbf{Nội dung} \\
\hline
\endfirsthead
\hline
\textbf{Mã yêu cầu} & \textbf{Nhóm yêu cầu} & \textbf{Nội dung} \\
...
NFR-01 & Bảo mật & Kiểm soát quyền truy cập API bằng Access Token và hỗ trợ duy trì phiên bằng Refresh Token \\
\hline
NFR-02 & Nhất quán dữ liệu & Dữ liệu được gắn với người dùng, có ràng buộc quan hệ và lưu snapshot dinh dưỡng khi cần \\
\hline
NFR-03 & Khả năng sử dụng & Giao diện rõ ràng, hỗ trợ thao tác nhập liệu, hiển thị trạng thái xử lý và thông báo lỗi \\
\hline
NFR-04 & Hiệu năng & Đảm bảo thời gian phản hồi phù hợp cho các chức năng thường xuyên sử dụng \\
\hline
NFR-05 & Khả năng mở rộng & Kiến trúc phân lớp, tách biệt Frontend, Backend, Service, Model và cơ sở dữ liệu \\
\hline
NFR-06 & Tích hợp bên ngoài & Xử lý và chuẩn hóa dữ liệu từ Open Food Facts API và Gemini AI Vision \\
\hline
NFR-07 & Bảo trì & Mã nguồn được tổ chức theo module, component và service để thuận lợi cho kiểm thử và mở rộng \\
\hline
\end{longtable}
...
Trong phạm vi đề tài, các nghiệp vụ chính của hệ thống được tổng hợp trong Bảng \ref{tab:nghiep_vu_chinh}.
...
Sau khi đăng nhập thành công, hệ thống kiểm tra trạng thái khởi tạo hồ sơ của người dùng. Nếu người dùng chưa hoàn tất hồ sơ sức khỏe ban đầu, giao diện sẽ điều hướng tới trang Onboarding. Tại đây, người dùng khai báo các thông tin như giới tính, tuổi hoặc ngày sinh, chiều cao, cân nặng, mức độ vận động và mục tiêu cá nhân. Mức độ vận động được thu thập trong hồ sơ ban đầu vì hoạt động thể chất thường xuyên là một trong những yếu tố chính quyết định nhu cầu năng lượng ở người trưởng thành. Thông tin này được ánh xạ thành hệ số PAL và kết hợp với BMR để ước lượng TDEE tĩnh \cite{fao_who_unu_2001}.

Dữ liệu hồ sơ được Backend kiểm tra và lưu vào cơ sở dữ liệu. Từ các thông tin này, hệ thống tính toán các chỉ số nền tảng như BMI, BMR, TDEE, mục tiêu năng lượng, tỷ lệ chất đa lượng và mục tiêu nước. BMR được sử dụng để ước lượng mức năng lượng cơ thể tiêu hao trong trạng thái nghỉ, làm cơ sở cho việc tính toán TDEE và mục tiêu năng lượng cá nhân \cite{mifflin1990}. Sau khi hoàn tất Onboarding, người dùng được chuyển tới các màn hình chức năng chính như Dashboard, nhật ký ăn uống, Meal Planner, cân nặng, luyện tập và hồ sơ cá nhân. Tổng hợp các luồng nghiệp vụ chính của hệ thống được trình bày trong Bảng \ref{tab:nghiep_vu_chinh}.
...
\caption{Tổng hợp các luồng nghiệp vụ chính của hệ thống}
\label{tab:nghiep_vu_chinh} \\
\hline
\textbf{Nghiệp vụ} & \textbf{Dữ liệu đầu vào} & \textbf{Xử lý chính} & \textbf{Kết quả đầu ra} \\
\hline
\endfirsthead
\hline
\textbf{Nghiệp vụ} & \textbf{Dữ liệu đầu vào} & \textbf{Xử lý chính} & \textbf{Kết quả đầu ra} \\
...
Đăng ký, đăng nhập & Họ tên, email, mật khẩu & Kiểm tra tài khoản, xác thực thông tin, cấp Access Token và Refresh Token & Người dùng được xác thực và truy cập hệ thống \\
\hline
Khởi tạo hồ sơ sức khỏe & Giới tính, tuổi, chiều cao, cân nặng, mức độ vận động, mục tiêu & Lưu hồ sơ, tính BMI, BMR, TDEE, mục tiêu năng lượng, macro và nước & Hồ sơ sức khỏe được khởi tạo, người dùng được chuyển vào hệ thống chính \\
\hline
Ghi nhật ký ăn uống & Thực phẩm, khẩu phần, bữa ăn, ngày ghi nhận & Tính dinh dưỡng theo khẩu phần, lưu bản ghi nhật ký và dữ liệu snapshot & Nhật ký ăn uống và tổng dinh dưỡng trong ngày được cập nhật \\
\hline
Ghi nhận nước uống & Lượng nước uống, ngày ghi nhận & Lưu dữ liệu nước uống, tổng hợp theo ngày & Tiến độ nước uống được cập nhật trên Dashboard \\
\hline
Theo dõi cân nặng & Cân nặng, ngày ghi nhận & Lưu lịch sử cân nặng, cập nhật biểu đồ và xu hướng & Dữ liệu cân nặng được dùng cho theo dõi và Adaptive TDEE \\
\hline
Ghi nhận luyện tập & Hoạt động, thời lượng hoặc năng lượng tiêu hao & Lưu dữ liệu luyện tập, tổng hợp năng lượng tiêu hao & Dữ liệu vận động được hiển thị trên Dashboard và báo cáo \\
\hline
Hybrid Nutrition Scanner & Mã vạch hoặc ảnh bảng thành phần dinh dưỡng & Tra cứu dữ liệu nội bộ, gọi Open Food Facts hoặc AI Vision, chuẩn hóa kết quả & Thông tin sản phẩm được trả về để ghi nhật ký hoặc đóng góp dữ liệu \\
\hline
Xem Dashboard & Ngày xem, dữ liệu người dùng & Tổng hợp hồ sơ, nhật ký, nước uống, cân nặng, luyện tập và phân tích & Các chỉ số tổng hợp và nhận xét được hiển thị \\
\hline
Xây dựng thực đơn & Mục tiêu dinh dưỡng, bữa ăn, mẫu bữa, dữ liệu thực phẩm & Tính toán khẩu phần thực phẩm theo mục tiêu & Thực đơn gợi ý được tạo và có thể dùng cho nhật ký ăn uống \\
\hline
Xuất báo cáo PDF & Khoảng thời gian cần báo cáo & Tổng hợp dữ liệu hồ sơ, nhật ký, cân nặng, luyện tập, nước uống và phân tích & File PDF báo cáo được tạo \\
\hline
\end{longtable}
...
\hline
Open Food Facts API & Hệ thống bên ngoài & Cung cấp dữ liệu sản phẩm theo mã vạch khi cơ sở dữ liệu nội bộ chưa có dữ liệu phù hợp \\
\hline
Gemini AI Vision & Hệ thống bên ngoài & Hỗ trợ nhận dạng bảng thành phần dinh dưỡng từ hình ảnh \\
\hline
\end{tabular}
\end{table}
...
Hình \ref{fig:usecase_tong_the} trình bày biểu đồ Use Case tổng thể của hệ thống. Tác nhân chính của hệ thống là Người dùng, thực hiện các nhóm chức năng gồm đăng ký, đăng nhập, quản lý hồ sơ sức khỏe, ghi nhận nhật ký ăn uống, ghi nhận nước uống, theo dõi cân nặng, ghi nhận luyện tập, sử dụng Hybrid Nutrition Scanner, xem Dashboard, xây dựng thực đơn và xuất báo cáo PDF. Hai hệ thống bên ngoài gồm Open Food Facts API và Gemini AI Vision được liên kết với nhóm Use Case Hybrid Nutrition Scanner để hỗ trợ tra cứu sản phẩm theo mã vạch và nhận dạng bảng thành phần dinh dưỡng từ hình ảnh. Danh sách chi tiết các Use Case chính được trình bày trong Bảng \ref{tab:danh_sach_usecase}.
...
\subsection{Danh sách Use Case chính}Bảng \ref{tab:danh_sach_usecase} tổng hợp các Use Case chính của hệ thống. Các Use Case này được lựa chọn dựa trên những chức năng có vai trò trực tiếp trong quá trình sử dụng của người dùng và được triển khai trong hệ thống.
...
\hline
\textbf{Mã Use Case} & \textbf{Tên Use Case} & \textbf{Tác nhân} & \textbf{Mô tả} \\
\hline
\endfirsthead
\hline
\textbf{Mã Use Case} & \textbf{Tên Use Case} & \textbf{Tác nhân} & \textbf{Mô tả} \\
...
UC01 & Đăng ký tài khoản & Người dùng & Tạo tài khoản mới để sử dụng hệ thống \\
\hline
UC02 & Đăng nhập & Người dùng & Xác thực tài khoản và truy cập hệ thống \\
\hline
UC03 & Khởi tạo và cập nhật hồ sơ sức khỏe & Người dùng & Khai báo hoặc chỉnh sửa thông tin phục vụ tính toán dinh dưỡng \\
\hline
UC04 & Ghi nhật ký ăn uống & Người dùng & Thêm thực phẩm đã sử dụng vào nhật ký theo từng bữa \\
\hline
UC05 & Ghi nhận nước uống & Người dùng & Ghi nhận lượng nước uống trong ngày và theo dõi tiến độ so với mục tiêu \\
\hline
UC06 & Tìm kiếm thực phẩm & Người dùng & Tìm kiếm thực phẩm trong cơ sở dữ liệu để ghi nhật ký hoặc xây dựng thực đơn \\
\hline
UC07 & Theo dõi cân nặng & Người dùng & Ghi nhận cân nặng theo thời gian \\
\hline
UC08 & Ghi nhận luyện tập & Người dùng & Lưu thông tin hoạt động vận động và năng lượng tiêu hao \\
\hline
UC09 & Xem Dashboard & Người dùng & Xem các chỉ số tổng hợp, biểu đồ và nhận xét phân tích \\
\hline
UC10 & Xây dựng thực đơn & Người dùng & Nhận gợi ý thực đơn dựa trên mục tiêu dinh dưỡng \\
\hline
UC11 & Quét mã vạch sản phẩm & Người dùng & Tra cứu thông tin sản phẩm đóng gói theo mã vạch \\
\hline
UC12 & Nhận dạng bảng thành phần dinh dưỡng & Người dùng & Trích xuất thông tin dinh dưỡng từ ảnh bảng thành phần \\
\hline
UC13 & Xuất báo cáo PDF & Người dùng & Tạo báo cáo tổng hợp dữ liệu dinh dưỡng theo khoảng thời gian \\
\hline
\end{longtable}
...
Nếu thông tin đăng nhập không hợp lệ, hệ thống trả về thông báo lỗi để người dùng kiểm tra lại dữ liệu đã nhập (Chi tiết xem Bảng \ref{tab:uc_dang_nhap}).
...
Một điểm quan trọng trong Use Case này là hệ thống cần lưu lại giá trị dinh dưỡng tại thời điểm ghi nhật ký. Cách xử lý này giúp dữ liệu lịch sử không bị thay đổi khi thông tin thực phẩm gốc được chỉnh sửa sau đó (Chi tiết xem Bảng \ref{tab:uc_ghi_nhat_ky}).

\begin{longtable}{|>{\raggedright\arraybackslash}p{5cm}|p{10cm}|}
\caption{Đặc tả rút gọn Use Case đăng nhập}
...
\hline
Luồng chính & Nhập thông tin đăng nhập, gửi yêu cầu, xác thực tài khoản, cấp Access Token và Refresh Token, điều hướng theo trạng thái hồ sơ \\
\hline
Luồng thay thế & Email hoặc mật khẩu không hợp lệ, hệ thống trả thông báo lỗi \\
\hline
Hậu điều kiện & Người dùng được xác thực và có thể truy cập các chức năng phù hợp \\
\hline
\end{longtable}
...
Với luồng nhận dạng bảng thành phần dinh dưỡng, người dùng gửi ảnh bảng thông tin sản phẩm. Hệ thống sử dụng Gemini AI Vision để trích xuất dữ liệu dinh dưỡng, sau đó kiểm tra và chuẩn hóa kết quả trước khi sử dụng (Chi tiết xem Bảng \ref{tab:uc_scanner}).
...
Tên Use Case & Ghi nhật ký ăn uống \\
\hline
Tác nhân & Người dùng \\
\hline
Tiền điều kiện & Người dùng đã đăng nhập và có dữ liệu thực phẩm phù hợp \\
\hline
Luồng chính & Chọn thực phẩm, nhập khẩu phần, chọn bữa ăn, xác nhận thêm vào nhật ký, hệ thống tính toán và lưu dữ liệu \\
\hline
Luồng thay thế & Không tìm thấy thực phẩm phù hợp, người dùng tìm kiếm lại hoặc sử dụng Scanner \\
\hline
Hậu điều kiện & Nhật ký ăn uống được cập nhật và tổng dinh dưỡng trong ngày được tính lại \\
\hline
\end{longtable}
...
Tên Use Case & Sử dụng Hybrid Nutrition Scanner \\
\hline
Tác nhân & Người dùng \\
\hline
Hệ thống liên quan & Open Food Facts API, Gemini AI Vision \\
\hline
Tiền điều kiện & Người dùng đã đăng nhập \\
\hline
Luồng chính & Quét mã vạch hoặc gửi ảnh, hệ thống tìm kiếm dữ liệu nội bộ, gọi dịch vụ bên ngoài nếu cần, chuẩn hóa kết quả và trả về giao diện \\
\hline
Luồng thay thế & Không tìm thấy sản phẩm hoặc ảnh không đủ dữ liệu, hệ thống thông báo để người dùng nhập lại hoặc bổ sung thủ công \\
\hline
Hậu điều kiện & Dữ liệu sản phẩm được trả về, lưu trữ hoặc sử dụng để ghi nhật ký \\
\hline
\end{longtable}
...
Trong phạm vi chương này, phần thiết kế cơ sở dữ liệu chỉ trình bày các nhóm bảng chính, quan hệ giữa các bảng và một số quyết định thiết kế quan trọng. Danh sách trường dữ liệu chi tiết, kiểu dữ liệu, ràng buộc cụ thể và ERD đầy đủ được trình bày trong Phụ lục C. Sơ đồ ERD rút gọn được minh họa trong Hình \ref{fig:erd_rut_gon}.

Hình \ref{fig:request_auth_flow} mô tả chi tiết luồng xử lý bên trong hệ thống khi một request có xác thực được gửi lên. Frontend đính kèm Access Token vào header, Middleware kiểm tra tính hợp lệ của token trước khi chuyển request vào Controller. Controller điều phối sang Service để xử lý nghiệp vụ, Service làm việc với Sequelize Model để truy vấn MySQL, kết quả được trả ngược lại Frontend dưới dạng JSON.
...
\textbf{Nhóm thực phẩm} lưu dữ liệu về món ăn, nguyên liệu hoặc sản phẩm được sử dụng trong hệ thống. Cơ sở dữ liệu thành phần thực phẩm là đầu vào cần thiết cho việc tính toán khẩu phần, tổng hợp năng lượng và đánh giá lượng chất dinh dưỡng. Các bảng thành phần thực phẩm cung cấp dữ liệu chuẩn hóa để phục vụ nghiên cứu khẩu phần, xây dựng chế độ ăn và hỗ trợ lựa chọn thực phẩm \cite{vien_dinh_duong_2007}. Dựa trên cách tiếp cận đó, bảng Food chứa thông tin dinh dưỡng như năng lượng, protein, carbohydrate, chất béo, chất xơ, đường, natri và một số vi chất. Các trường thành phần dinh dưỡng được biểu diễn trên một lượng thực phẩm tham chiếu, phổ biến là 100 g phần ăn được \cite{vien_dinh_duong_2007}. Cấu trúc này tạo điều kiện cho quy đổi theo khẩu phần và tổng hợp dữ liệu nhật ký phục vụ Food Scoring, Meal Planner và Scanner.
...
Báo cáo PDF không được thiết kế thành một nhóm bảng riêng. Dữ liệu báo cáo được tổng hợp trực tiếp từ hồ sơ người dùng, nhật ký ăn uống, nước uống, cân nặng, luyện tập và các dữ liệu phân tích tại thời điểm xuất báo cáo. Chi tiết việc phân nhóm các bảng dữ liệu được thể hiện trong Bảng \ref{tab:phan_nhom_bang}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|p{7cm}|}
\caption{Phân nhóm bảng dữ liệu của hệ thống}
\label{tab:phan_nhom_bang} \\
\hline
\textbf{Nhóm dữ liệu} & \textbf{Một số bảng chính} & \textbf{Vai trò} \\
\hline
\endfirsthead
\hline
\textbf{Nhóm dữ liệu} & \textbf{Một số bảng chính} & \textbf{Vai trò} \\
...
Người dùng và hồ sơ & User & Lưu tài khoản, hồ sơ sức khỏe và cấu hình cá nhân \\
\hline
Thực phẩm & Food & Lưu dữ liệu dinh dưỡng của thực phẩm \\
\hline
Nhật ký ăn uống & DiaryEntry & Lưu thực phẩm người dùng đã sử dụng theo ngày và bữa \\
\hline
Theo dõi sức khỏe & WeightLog, WaterLog, ExerciseLog & Lưu cân nặng, nước uống và luyện tập \\
\hline
Meal Planner & MealTemplate, UserMealConfig & Lưu mẫu bữa ăn và cấu hình phân bổ bữa ăn \\
\hline
Adaptive TDEE & AdaptiveTDEELog & Lưu lịch sử tính toán TDEE thích ứng \\
\hline
Scanner & ScannedProduct, ProductContribution & Lưu sản phẩm quét và dữ liệu đóng góp \\
\hline
\end{longtable}
...
Đối với Scanner, một sản phẩm trong ScannedProduct có thể có nhiều bản ghi đóng góp trong ProductContribution. Mỗi đóng góp liên kết với một người dùng và một sản phẩm được quét. Nếu sản phẩm đã được chuẩn hóa thành dữ liệu thực phẩm sử dụng chung, ScannedProduct có thể liên kết tùy chọn với Food. Tóm tắt khóa chính và khóa ngoại của một số bảng tiêu biểu được thể hiện trong Bảng \ref{tab:tom_tat_khoa}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{3.5cm}|>{\raggedright\arraybackslash}p{2cm}|>{\raggedright\arraybackslash}p{4.5cm}|>{\raggedright\arraybackslash}p{5cm}|}
\caption{Tóm tắt khóa chính và khóa ngoại của một số bảng chính}
\label{tab:tom_tat_khoa} \\
\hline
...
\hline
Food & id & userId, nếu là thực phẩm do người dùng tạo & Lưu dữ liệu thực phẩm \\
\hline
...
\begin{figure}[htbp]
    ...
    % BACKEND
    \node[box] (api) at (6, 5) {\textbf{RESTful API Route}\\[1ex] \scriptsize \texttt{/api/v1/auth}, \texttt{/api/v1/diary},\\[0.5ex] \texttt{/api/v1/dashboard}, ...};
...
Cách thiết kế phản hồi thống nhất giúp giảm sự phức tạp trong xử lý lỗi ở Frontend. Các thành phần giao diện có thể dựa vào trường success, data, message và errors để xác định trạng thái xử lý. Cấu trúc chung cho phản hồi API được minh họa trong Bảng \ref{tab:cau_truc_phan_hoi}.
...
Luồng xác thực API bằng JWT được thiết kế như trong Hình \ref{fig:jwt-auth-flow}.
...
\node[box] (saveToken) at (0,-2.0) {Lưu Access Token\\vào bộ nhớ tạm};
...
\begin{tikzpicture}[
    node distance=0pt,
    % --- Kiểu hộp chính (xanh dương nhạt) ---
    mainbox/.style={
        rectangle, draw=blue!60!black, thick,
        fill=blue!8, rounded corners=5pt,
        text width=6.2cm, align=center,
        font=\small\sffamily, inner sep=8pt,
        minimum height=1.1cm
    },
    % --- Hộp database (xanh lá) ---
    dbbox/.style={
        rectangle, draw=green!50!black, thick,
        fill=green!10, rounded corners=5pt,
        text width=6.2cm, align=center,
        font=\small\sffamily, inner sep=8pt,
        minimum height=1.1cm
    },
    % --- Hộp lỗi (đỏ) ---
    errbox/.style={
        rectangle, draw=red!70!black, thick,
        fill=red!8, rounded corners=5pt,
        text width=3.8cm, align=center,
        font=\scriptsize\sffamily, inner sep=6pt
    },
    % --- Mũi tên request (đi xuống, xanh đậm) ---
    req/.style={-Latex, thick, blue!70!black},
    % --- Mũi tên response (đi lên, đỏ nét đứt) ---
    res/.style={Latex-, thick, red!70!black, dashed},
    % --- Nhãn request ---
    lreq/.style={font=\scriptsize\sffamily, text=blue!70!black,
                 fill=white, inner sep=2pt, right},
    % --- Nhãn response ---
    lres/.style={font=\scriptsize\sffamily, text=red!70!black,
                 fill=white, inner sep=2pt, left}
]

% ── Khoảng cách dọc giữa các node ──
\def\gap{1.85cm}

% ── Các node theo chiều dọc ──
\node[mainbox, fill=blue!15] (fe) at (0, 0)
    {\textbf{Frontend (React + Axios)}\\[2pt]
     \scriptsize Gửi HTTP Request kèm \texttt{Authorization: Bearer <accessToken>}};

\node[mainbox] (mw) at (0, -\gap)
    {\textbf{Middleware --- \texttt{verifyToken}}\\[2pt]
     \scriptsize Giải mã JWT, kiểm tra chữ ký \& thời hạn, gắn \texttt{req.user}};

\node[mainbox] (ctrl) at (0, -2*\gap)
    {\textbf{Controller}\\[2pt]
     \scriptsize Nhận request, gọi Service tương ứng, trả HTTP Response};

\node[mainbox] (svc) at (0, -3*\gap)
    {\textbf{Service}\\[2pt]
     \scriptsize Xử lý nghiệp vụ, tính toán dinh dưỡng, tổng hợp dữ liệu};

\node[mainbox] (model) at (0, -4*\gap)
    {\textbf{Sequelize Model}\\[2pt]
     \scriptsize Ánh xạ đối tượng sang bảng, thực thi truy vấn CRUD};

\node[dbbox] (db) at (0, -5*\gap)
    {\textbf{MySQL Database}\\[2pt]
     \scriptsize Lưu trữ \& trả về dữ liệu từ các bảng tương ứng};

% ── Hộp lỗi 401 (nhánh sang phải của Middleware) ──
\node[errbox] (err) at (5.5, -\gap)
    {\textbf{401 Unauthorized}\\[2pt]
     Token không hợp lệ\\hoặc hết hạn};

% ────────────────────────────────────────────
% Mũi tên REQUEST (đường liền xanh, bên trái)
% ────────────────────────────────────────────
\draw[req] ([xshift=-0.35cm]fe.south)
        -- node[lreq, xshift=-0.1cm] {HTTP Request + Bearer Token}
           ([xshift=-0.35cm]mw.north);

\draw[req] ([xshift=-0.35cm]mw.south)
        -- node[lreq, xshift=-0.1cm] {Token hợp lệ -- chuyển tiếp}
           ([xshift=-0.35cm]ctrl.north);

\draw[req] ([xshift=-0.35cm]ctrl.south)
        -- node[lreq, xshift=-0.1cm] {Gọi \texttt{service.method()}}
           ([xshift=-0.35cm]svc.north);

\draw[req] ([xshift=-0.35cm]svc.south)
        -- node[lreq, xshift=-0.1cm] {Truy vấn Model}
           ([xshift=-0.35cm]model.north);

\draw[req] ([xshift=-0.35cm]model.south)
        -- node[lreq, xshift=-0.1cm] {SQL Query}
           ([xshift=-0.35cm]db.north);

% ────────────────────────────────────────────
% Mũi tên RESPONSE (đường đứt đỏ, bên phải)
% ────────────────────────────────────────────
\draw[res] ([xshift=0.35cm]db.north)
        -- node[lres, xshift=0.1cm] {Dữ liệu thô}
           ([xshift=0.35cm]model.south);

\draw[res] ([xshift=0.35cm]model.north)
        -- node[lres, xshift=0.1cm] {Object / Array}
           ([xshift=0.35cm]svc.south);

\draw[res] ([xshift=0.35cm]svc.north)
        -- node[lres, xshift=0.1cm] {Kết quả nghiệp vụ}
           ([xshift=0.35cm]ctrl.south);

\draw[res] ([xshift=0.35cm]ctrl.north)
        -- node[lres, xshift=0.1cm] {HTTP Response JSON}
           ([xshift=0.35cm]mw.south);

\draw[res] ([xshift=0.35cm]mw.north)
        -- node[lres, xshift=0.1cm] {\texttt{\{"success":true,"data":\{...\}\}}}
           ([xshift=0.35cm]fe.south);

% ── Mũi tên nhánh lỗi từ Middleware ──
\draw[-Latex, thick, red!70!black]
    (mw.east) -- node[above, font=\scriptsize\sffamily,
                      text=red!70!black, fill=white, inner sep=2pt]
                  {Token sai / hết hạn} (err.west);

% ── Chú thích ──
\node[font=\scriptsize\itshape\sffamily, text=gray!80!black,
      align=center, text width=10cm] at (0, -5*\gap - 1.3cm) {%
    \textbf{Chú thích:}~~
    \textcolor{blue!70!black}{$\longrightarrow$} Luồng Request (đường liền)
    \quad
    \tikz[baseline=-0.5ex] \draw[dashed, ->, red!70!black, thick] (0,0) -- (0.4,0); Luồng Response (đường đứt)
};

\end{tikzpicture}%
}
\caption{Luồng xử lý một request có xác thực trong hệ thống}
\label{fig:request_auth_flow}
\end{figure}

Các API của hệ thống được chia thành hai nhóm: API công khai và API yêu cầu xác thực.
...
Cách thiết kế này giúp bảo vệ các API nghiệp vụ, đồng thời giảm việc yêu cầu người dùng đăng nhập lại trong quá trình sử dụng. Các nhóm API chính của hệ thống được liệt kê trong Bảng \ref{tab:nhom_api_chinh}.
...
\subsection{Một số endpoint tiêu biểu}Bảng dưới đây trình bày một số endpoint tiêu biểu đại diện cho các nhóm chức năng quan trọng của hệ thống. Các endpoint được lựa chọn nhằm thể hiện cách tổ chức API và vai trò của từng nhóm nghiệp vụ. Danh sách đầy đủ các endpoint được trình bày trong Phụ lục B. Một số endpoint tiêu biểu được trình bày trong Bảng \ref{tab:endpoint_tieu_bieu}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{1.5cm}|>{\raggedright\arraybackslash}p{5.5cm}|>{\raggedright\arraybackslash}p{5.0cm}|}
\caption{Một số endpoint tiêu biểu của hệ thống}
\label{tab:endpoint_tieu_bieu} \\
\hline
\textbf{Nhóm API} & \textbf{Phương thức} & \textbf{Endpoint} & \textbf{Mô tả} \\
\hline
\endfirsthead
\hline
\textbf{Nhóm API} & \textbf{Phương thức} & \textbf{Endpoint} & \textbf{Mô tả} \\
...
\hline
Auth & POST & /api/v1/auth/login & Đăng nhập và nhận Access Token \\
\hline
Auth & POST & /api/v1/auth/refresh-token & Làm mới Access Token \\
\hline
Dashboard & GET & /api/v1/dashboard?date=YYYY-MM-DD & Lấy dữ liệu tổng hợp cho Dashboard theo ngày \\
\hline
Diary & GET & /api/v1/diary & Lấy nhật ký ăn uống theo ngày \\
\hline
Diary & POST & /api/v1/diary/entries & Thêm thực phẩm vào nhật ký \\
\hline
Diary & GET & /api/v1/diary/foods/search & Tìm kiếm thực phẩm \\
\hline
Profile & POST & /api/v1/profile/onboarding & Lưu thông tin khởi tạo hồ sơ \\
\hline
Profile & PUT & /api/v1/profile/macros & Cập nhật cấu hình macro \\
\hline
Weight & POST & /api/v1/weight & Thêm bản ghi cân nặng \\
\hline
Water & POST & /api/v1/water & Ghi nhận lượng nước uống \\
\hline
Exercise & POST & /api/v1/exercise & Thêm hoạt động luyện tập \\
\hline
Meal Planner & POST & /api/v1/meal-planner/generate & Sinh gợi ý thực đơn \\
\hline
Adaptive TDEE & GET & /api/v1/adaptive-tdee/status & Lấy trạng thái Adaptive TDEE \\
\hline
Scanner & POST & /api/v1/scanner/barcode-lookup & Tra cứu sản phẩm theo mã vạch \\
\hline
Scanner & POST & /api/v1/scanner/ai-vision & Nhận dạng bảng thành phần dinh dưỡng từ ảnh \\
\hline
Scanner & POST & /api/v1/scanner/confirm-contribution & Xác nhận và lưu dữ liệu sản phẩm đóng góp \\
\hline
Report & GET & /api/v1/report/pdf?range=week & Xuất báo cáo PDF theo tuần \\
\hline
\end{longtable}


\subsection{Xử lý lỗi và mã trạng thái}Các API của hệ thống sử dụng mã trạng thái HTTP để phản ánh kết quả xử lý. Việc kết hợp mã trạng thái với cấu trúc phản hồi thống nhất giúp Frontend xác định được nguyên nhân lỗi và đưa ra phản hồi phù hợp cho người dùng. Một số mã trạng thái HTTP phổ biến được sử dụng bởi API được thống kê trong Bảng \ref{tab:ma_trang_thai_api}.

\begin{longtable}{|>{\raggedright\arraybackslash}p{5cm}|p{10cm}|}
\caption{Một số mã trạng thái API}
\label{tab:ma_trang_thai_api} \\
\hline
\textbf{Mã trạng thái} & \textbf{Ý nghĩa} \\
\hline
\endfirsthead
\hline
\textbf{Mã trạng thái} & \textbf{Ý nghĩa} \\
...
\hline
404 & Không tìm thấy tài nguyên hoặc endpoint tương ứng \\
\hline
409 & Xung đột dữ liệu \\
\hline
422 & Lỗi kiểm tra dữ liệu đầu vào \\
\hline
...
Thanh điều hướng được sử dụng để chuyển giữa các chức năng chính. Vùng nội dung chính thay đổi theo trang hiện tại. Các thành phần dùng chung như nút, thẻ thông tin, biểu đồ, modal và biểu mẫu được tái sử dụng giữa nhiều màn hình để giữ giao diện nhất quán. Sơ đồ điều hướng giao diện được mô tả trong Hình \ref{fig:ui-navigation}.
...
\node[page] (report)    at (15.0, -3.0) {Báo cáo / Thống kê};
...
\draw[arrow] (forkApp) |- (report.west);
...
Dashboard không chỉ hiển thị dữ liệu mà còn đóng vai trò là điểm truy cập nhanh tới một số thao tác thường dùng như thêm thực phẩm, ghi nhận nước uống hoặc xem báo cáo. Vì vậy, giao diện cần ưu tiên khả năng tổng hợp, dễ quan sát và hạn chế số bước thao tác. Thiết kế wireframe của Dashboard được thể hiện trong Hình \ref{fig:dashboard-ui}.
...
\begin{tikzpicture}[
    ...
    card/.style={draw=gray!30, rounded corners, fill=white, align=center, inner sep=2mm, minimum width=2.6cm, font=\scriptsize},
    title/.style={font=\bfseries\small, text=black!80}
]

% Background
\fill[gray!5, rounded corners] (0, 0) rectangle (15.5, -11.8);
\draw[gray!30, rounded corners] (0, 0) rectangle (15.5, -11.8);

% Sidebar
\fill[white, rounded corners] (0, 0) rectangle (3.5, -11.8);
\draw[gray!30] (3.5, 0) -- (3.5, -11.8);

\node[circle, fill=blue!10, minimum size=1.0cm, font=\bfseries] (avatar) at (1.75, -1.2) {B};
\node[font=\bfseries\footnotesize] at (1.75, -2.1) {Nguyễn Thị B};
\draw[gray!30] (0.5, -2.5) -- (3.0, -2.5);

\node[fill=gray!10, rounded corners, anchor=west, minimum width=2.8cm, minimum height=0.6cm] at (0.35, -3.2) {\footnotesize \textbf{Tổng quan}};
\node[anchor=west, minimum width=2.8cm, minimum height=0.6cm, text=gray!80!black] at (0.35, -4.0) {\footnotesize Nhật ký};
\node[anchor=west, minimum width=2.8cm, minimum height=0.6cm, text=gray!80!black] at (0.35, -4.8) {\footnotesize Lập kế hoạch};
\node[anchor=west, minimum width=2.8cm, minimum height=0.6cm, text=gray!80!black] at (0.35, -5.6) {\footnotesize Cân nặng};
\node[anchor=west, minimum width=2.8cm, minimum height=0.6cm, text=gray!80!black] at (0.35, -6.4) {\footnotesize Luyện tập};
\node[anchor=west, minimum width=2.8cm, minimum height=0.6cm, text=gray!80!black] at (0.35, -7.2) {\footnotesize Hồ sơ};

% Main Header
\node[anchor=north west, font=\bfseries\small] at (3.8, -0.4) {Chào buổi sáng, Nguyễn Thị B!};
\node[anchor=north east, draw=gray!50, rounded corners, fill=white, font=\scriptsize] at (15.2, -0.4) {$\leftarrow$ Hôm nay $\rightarrow$};

% Top Cards
\node[card, anchor=north west] at (3.8, -1.2) {Protein\\[1mm] \textbf{\large 96g}};
\node[card, anchor=north west] at (6.7, -1.2) {Carbs\\[1mm] \textbf{\large 86g}};
\node[card, anchor=north west] at (9.6, -1.2) {Fat\\[1mm] \textbf{\large 43g}};
\node[card, anchor=north west] at (12.5, -1.2) {Calo đốt\\[1mm] \textbf{\large 385} kcal};

% Middle Row
% Calo Hôm Nay
\node[panel, minimum width=5.6cm, minimum height=4.5cm, anchor=north west] at (3.8, -2.7) {};
\node[title, anchor=north west] at (4.0, -2.9) {Calo Hôm Nay};
\draw[line width=4mm, gray!20] (6.6, -5.2) circle (1.2cm);
\draw[line width=4mm, green!60!black] (6.6, -4.0) arc (90:-120:1.2cm); 
\node[align=center, font=\scriptsize] at (6.6, -5.2) {\textbf{\large 1130}\\ kcal};

% Nước uống
\node[panel, minimum width=5.6cm, minimum height=2.0cm, anchor=north west] at (9.6, -2.7) {};
\node[title, anchor=north west] at (9.8, -2.9) {Nước uống};
\node[anchor=north east, font=\scriptsize] at (15.0, -2.9) {2.7 / 2.6 L};
\foreach \x in {0,1,2,3,4} {
    \fill[cyan!50] (10.4 + \x*0.6, -4.0) circle (2.5mm);
}

% Phân tích AI
\node[panel, minimum width=5.6cm, minimum height=2.3cm, anchor=north west] at (9.6, -4.9) {};
\node[title, anchor=north west] at (9.8, -5.1) {Phân tích AI};
\node[anchor=north west, font=\scriptsize, align=left, text width=5.0cm, text=black!70] at (9.8, -5.6) {
  $\bullet$ Hôm nay bạn nạp hơi ít Protein. Ưu tiên thịt nạc, trứng.\\[1mm]
  $\bullet$ Calo đang thiếu, mới đạt 65\% mục tiêu.
};

% Bottom Row
% Bữa ăn gần đây
\node[panel, minimum width=5.6cm, minimum height=4.0cm, anchor=north west] at (3.8, -7.5) {};
\node[title, anchor=north west] at (4.0, -7.7) {Bữa ăn gần đây};

\node[anchor=west, font=\scriptsize] at (4.0, -8.6) {\textbf{Salad Trứng Luộc}};
\node[anchor=east, font=\scriptsize, text=green!70!black] at (9.2, -8.6) {+220 kcal};
\draw[gray!20] (4.0, -9.1) -- (9.2, -9.1);

\node[anchor=west, font=\scriptsize] at (4.0, -9.6) {\textbf{Ức Gà Áp Chảo}};
\node[anchor=east, font=\scriptsize, text=green!70!black] at (9.2, -9.6) {+220 kcal};
\draw[gray!20] (4.0, -10.1) -- (9.2, -10.1);

\node[anchor=west, font=\scriptsize] at (4.0, -10.6) {\textbf{Canh Bầu Nấu Tôm}};
\node[anchor=east, font=\scriptsize, text=green!70!black] at (9.2, -10.6) {+90 kcal};

% Hoạt động hôm nay
\node[panel, minimum width=5.6cm, minimum height=4.0cm, anchor=north west] at (9.6, -7.5) {};
\node[title, anchor=north west] at (9.8, -7.7) {Hoạt động hôm nay};

\node[anchor=west, font=\scriptsize] at (9.8, -8.6) {\textbf{Chạy bộ}};
\node[anchor=west, font=\scriptsize, text=gray] at (9.8, -9.0) {Thời gian: 40 phút};
\node[anchor=east, font=\scriptsize, text=orange] at (15.0, -8.6) {-385 kcal};

\end{tikzpicture}
}
\caption{Wireframe giao diện Dashboard}
...
Sau khi hệ thống sinh thực đơn, người dùng có thể thay thế nguyên liệu nếu cần hoặc xác nhận sử dụng kết quả. Kết quả thực đơn có thể được dùng làm dữ liệu đầu vào cho nhật ký ăn uống trong ngày. Do chức năng này liên quan trực tiếp đến thuật toán Meal Planner, giao diện cần thể hiện rõ dữ liệu đầu vào, trạng thái xử lý và kết quả đầu ra để người dùng hiểu được thao tác đang thực hiện. Chi tiết giao diện được minh họa trong Hình \ref{fig:meal_planner_ui}.
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[
        font=\sffamily,
        node distance=0.3cm,
        btn/.style={draw=green!70!black, fill=green!80!black, rounded corners=5pt, text=white, font=\small\bfseries, inner sep=6pt},
        btn_small/.style={draw=gray!40, fill=white, rounded corners=2pt, font=\scriptsize, inner sep=2pt, text=gray!80!black},
        btn_pin/.style={draw=orange!80!black, fill=orange!20, rounded corners=2pt, text=black!80, font=\scriptsize\bfseries, inner sep=2pt},
        panel/.style={draw=gray!20, fill=gray!5, rounded corners=6pt, inner sep=6pt},
        title/.style={font=\small\bfseries, text=black!80},
        item/.style={draw=gray!30, fill=white, rounded corners=3pt, inner sep=4pt},
        item_active/.style={draw=green!60!black, fill=green!5, rounded corners=3pt, inner sep=4pt, thick}
    ]

    % Block 1: Chọn bữa ăn
    \node[title] at (0,0) (b1_title) {1. Chọn bữa ăn};
    \node[item_active, minimum width=2.8cm, below=0.2cm of b1_title.south west, anchor=north west] (meal1) {\textbf{Bữa sáng} \textcolor{orange!80!black}{\scriptsize 25\%}};
    \node[item, minimum width=2.8cm, right=0.2cm of meal1] (meal2) {\textbf{Bữa trưa} \textcolor{blue!60}{\scriptsize 35\%}};
    \node[item, minimum width=2.8cm, right=0.2cm of meal2] (meal3) {\textbf{Bữa tối} \textcolor{purple!60}{\scriptsize 30\%}};
    \node[item, minimum width=2.8cm, right=0.2cm of meal3] (meal4) {\textbf{Bữa phụ} \textcolor{green!60!black}{\scriptsize 10\%}};

    % Block 2: Chọn template
    \node[title, below=0.4cm of meal1.south west, anchor=north west] (b2_title) {2. Chọn template};
    \node[item_active, minimum width=6.0cm, below=0.15cm of b2_title.south west, anchor=north west] (tpl1) {
        \begin{tabular}{@{}l@{}}
            \textbf{Cơm truyền thống}\\
            {\scriptsize Cơm trắng/gạo lứt, thịt/cá, rau luộc.}
        \end{tabular}
    };
    \node[item, minimum width=6.0cm, right=0.2cm of tpl1] (tpl2) {
        \begin{tabular}{@{}l@{}}
            \textbf{Bowl Healthy}\\
            {\scriptsize Yến mạch, protein nạc, rau xanh.}
        \end{tabular}
    };

    % Block 3: Ghim nguyên liệu
    \node[title, below=0.4cm of tpl1.south west, anchor=north west] (b3_title) {2.5. Ghim sẵn nguyên liệu (Tùy chọn)};
    \node[panel, minimum width=12.4cm, minimum height=2.4cm, below=0.15cm of b3_title.south west, anchor=north west] (b3_panel) {};
    \node[item, minimum width=5.6cm, anchor=north west, xshift=0.2cm, yshift=-0.2cm] at (b3_panel.north west) (ing1) {\footnotesize Tinh Bột \hfill Khoai lang $\downarrow$};
    \node[btn_pin, anchor=east, xshift=-0.3cm] at (ing1.east) {\scriptsize Ghim};
    \node[item, minimum width=5.6cm, anchor=north east, xshift=-0.2cm, yshift=-0.2cm] at (b3_panel.north east) (ing2) {\footnotesize Chất Đạm \hfill -- Ngẫu nhiên -- $\downarrow$};
    \node[item, minimum width=5.6cm, below=0.2cm of ing1.south west, anchor=north west] (ing3) {\footnotesize Chất Xơ \hfill -- Ngẫu nhiên -- $\downarrow$};
    \node[item, minimum width=5.6cm, below=0.2cm of ing2.south west, anchor=north west] (ing4) {\footnotesize Chất Béo \hfill -- Ngẫu nhiên -- $\downarrow$};

    % Left Button (Tạo thực đơn)
    \node[btn, below=0.3cm of b3_panel.south west, anchor=north west] (gen_btn) {\quad Tạo thực đơn \quad};

    % Block 4: Kết quả thực đơn
    \node[title, below=0.3cm of gen_btn.south west, anchor=north west] (b4_title) {3. Kết quả thực đơn};
    
    \node[panel, text width=11.8cm, below=0.15cm of b4_title.south west, anchor=north west, inner sep=0.3cm] (b4_panel) {
        \footnotesize
        \begin{tabular}{@{}>{\raggedright\arraybackslash}p{5cm}r r l@{}}
            \textcolor{gray}{\scriptsize\bfseries Nguyên liệu} & \textcolor{gray}{\scriptsize\bfseries Gram} & \textcolor{gray}{\scriptsize\bfseries Calo} & \\[4pt]
            \textbf{Khoai lang (Thô)} \textcolor{orange}{\tiny[Carb]} & \textbf{152g} & 131 kcal & \fbox{\scriptsize Đổi món} \\[4pt]
            \textbf{Cá rô phi (Thô)} \textcolor{blue}{\tiny[Protein]} & \textbf{94g} & 120 kcal & \fbox{\scriptsize Đổi món} \\[4pt]
            \textbf{Cà chua} \textcolor{green!60!black}{\tiny[Fiber]} & \textbf{200g} & 36 kcal & \fbox{\scriptsize Đổi món} \\
        \end{tabular}
    };

    % Tooltip for replace (anchored to b4_panel right edge)
    \node[draw=orange!60, fill=orange!5, rounded corners=3pt, inner sep=3pt, font=\scriptsize, anchor=west, align=left] at ([xshift=0.3cm]b4_panel.east |- b4_panel.center) (replace_modal) {
        \textbf{Gợi ý thay thế}\\
        $\circ$ Ức gà (105g)\\
        $\circ$ Đậu phụ (150g)
    };
    \draw[->, orange!60, thick, dashed] (replace_modal.west) -- (b4_panel.east |- b4_panel.center);

    \end{tikzpicture}
    }% end scalebox
    \caption{Wireframe giao diện chức năng Meal Planner}
    \label{fig:meal_planner_ui}
\end{figure}

\subsection{Tổng hợp các màn hình chức năng còn lại}Ngoài các màn hình trọng tâm như Dashboard, nhật ký ăn uống và Meal Planner, hệ thống còn có một số màn hình phục vụ các nghiệp vụ theo dõi và cấu hình cá nhân. Các màn hình này được mô tả tóm tắt trong Bảng \ref{tab:man_hinh_chuc_nang} nhằm tránh làm nội dung chương bị dàn trải.

\begin{table}[htbp]
\centering
\caption{Tổng hợp một số màn hình chức năng của hệ thống}
\label{tab:man_hinh_chuc_nang}
\begin{tabular}{|>{\raggedright\arraybackslash}p{4cm}|>{\raggedright\arraybackslash}p{4cm}|p{7cm}|}
\hline
\textbf{Màn hình} & \textbf{Vai trò} & \textbf{Thành phần chính} \\
\hline
Onboarding & Khởi tạo hồ sơ sức khỏe ban đầu cho người dùng & Biểu mẫu thông tin cá nhân, chiều cao, cân nặng, mức độ vận động, mục tiêu cá nhân \\
\hline
Theo dõi cân nặng & Lưu và hiển thị lịch sử cân nặng của người dùng & Biểu đồ cân nặng, danh sách bản ghi, biểu mẫu thêm cân nặng \\
\hline
Luyện tập & Ghi nhận hoạt động vận động và năng lượng tiêu hao & Danh sách hoạt động, biểu mẫu thêm luyện tập, thông tin năng lượng tiêu hao \\
\hline
Hồ sơ cá nhân & Cập nhật thông tin cơ thể, mục tiêu và cấu hình dinh dưỡng & Thông tin cá nhân, cấu hình macro, mục tiêu nước, thông tin dị ứng hoặc loại trừ thực phẩm \\
\hline
Xuất báo cáo PDF & Tổng hợp dữ liệu dinh dưỡng theo tuần hoặc tháng & Tùy chọn khoảng thời gian, nút xuất báo cáo, trạng thái tải file \\
\hline
\end{tabular}
\end{table}
...
\subsection{Adaptive TDEE}Adaptive TDEE là nhóm xử lý được xây dựng để điều chỉnh giá trị TDEE dựa trên dữ liệu thực tế của người dùng theo từng tuần. Trong Nutrition Core, TDEE được tính từ BMR và hệ số vận động. Cách tính này tạo ra giá trị nền ban đầu, tuy nhiên chưa phản ánh đầy đủ sự khác biệt giữa các cá nhân. Mối quan hệ giữa thâm hụt năng lượng và biến động cân nặng không hoàn toàn giống nhau; thành phần cơ thể ban đầu và tỷ lệ khối mỡ, khối không mỡ trong phần trọng lượng thay đổi có thể làm thay đổi năng lượng tương ứng với mỗi kilogram cân nặng giảm \cite{hall2008}. Vì vậy, NutriTrack sử dụng TDEE tĩnh làm mốc khởi điểm và bổ sung cơ chế Adaptive TDEE để hiệu chỉnh dần mức tiêu hao năng lượng ước lượng dựa trên nhật ký ăn uống và dữ liệu cân nặng đã ghi nhận.
...
Phần cốt lõi của Adaptive TDEE là ước lượng mức tiêu hao năng lượng từ năng lượng nạp trung bình và biến động cân nặng. Hệ thống sử dụng hệ số quy đổi xấp xỉ 7.700 kcal/kg, tương ứng với quy tắc thâm hụt tích lũy khoảng 3.500 kcal cho mỗi pound cân nặng giảm \cite{hall2008}. TDEE ước lượng theo tuần được xác định theo công thức:

\textbf{TDEE\textsubscript{estimated} = E\textsubscript{in} - $\frac{\Delta W \times 7700}{7}$}

Trong đó, \textbf{E\textsubscript{in}} là năng lượng nạp trung bình theo ngày và \textbf{$\Delta W$} là mức thay đổi cân nặng trong tuần. Khi cân nặng tăng, \textbf{$\Delta W$} mang giá trị dương nên TDEE ước lượng thấp hơn năng lượng nạp; khi cân nặng giảm, \textbf{$\Delta W$} mang giá trị âm nên TDEE ước lượng cao hơn năng lượng nạp.

Tuy nhiên, nghiên cứu của Hall chỉ ra rằng năng lượng thâm hụt trên mỗi đơn vị giảm cân phụ thuộc vào lượng mỡ ban đầu và thành phần của phần trọng lượng thay đổi, do đó 7.700 kcal/kg không phải hằng số chính xác tuyệt đối cho mọi cá nhân \cite{hall2008}. Do hệ số năng lượng trên mỗi kilogram thay đổi theo cơ địa, Adaptive TDEE không được xem là phép đo trực tiếp tổng năng lượng tiêu hao mà chỉ là giá trị suy luận từ nhật ký dinh dưỡng và xu hướng cân nặng \cite{hall2008}.
...
Để hạn chế tác động của dữ liệu thiếu và các kết quả cực đoan, hệ thống không sử dụng trực tiếp kết quả thô này mà bổ sung các kỹ thuật EMA, trung bình trượt, điều kiện dữ liệu tối thiểu và kiểm soát biên (giới hạn từ 70\% đến 130\% so với TDEE tĩnh). Các tham số cụ thể của cơ chế làm mượt này được lựa chọn dựa trên thiết kế nội bộ của hệ thống, không bắt nguồn trực tiếp từ nghiên cứu của Hall.
...
\hline
\textbf{Ý nghĩa hiển thị} & Từ 75 trở lên & Lành mạnh \\
\hline
Mật độ dinh dưỡng tốt trong phạm vi thuật toán & Từ 60 đến dưới 75 & Khá tốt \\
\hline
...
Nhóm kiểm tra thứ hai liên quan đến năng lượng. Do chất béo có hệ số năng lượng chung khoảng 9 kcal/g, giá trị năng lượng lý thuyết của 100 g chất béo là khoảng 900 kcal \cite{fao_2003, vien_dinh_duong_2007}. Từ cơ sở này, NutriTrack sử dụng 900 kcal/100 g làm giới hạn kiểm tra vật lý đầu tiên đối với dữ liệu AI trích xuất. Bên cạnh đó, năng lượng ước tính được kiểm tra chéo theo hệ số Atwater chung, với protein và carbohydrate cung cấp khoảng 4 kcal/g, còn lipid cung cấp khoảng 9 kcal/g \cite{fao_2003, vien_dinh_duong_2007}. Công thức tính là:

\textbf{E\textsubscript{Atwater} = protein × 4 + carbohydrate × 4 + fat × 9}

Trong phạm vi triển khai, ngưỡng sai lệch 15\% được lựa chọn làm tham số kiểm tra nội bộ. Nếu năng lượng đọc được lệch quá 15\% so với \textbf{E\textsubscript{Atwater}}, hệ thống đánh dấu cảnh báo. Tuy nhiên, do hệ số năng lượng thực tế có thể thay đổi theo từng loại thực phẩm (phụ thuộc vào chất xơ, polyol, acid hữu cơ), kết quả này chỉ dùng để đối chiếu tính hợp lý, không phải là phép xác định chính xác tuyệt đối \cite{fao_2003}. Đồng thời, theo quan hệ 1 kcal = 4,184 kJ \cite{fao_2003, vien_dinh_duong_2007}, giá trị biểu diễn bằng kJ thường lớn hơn giá trị kcal khoảng 4,184 lần. Vì vậy, khi năng lượng đọc được lớn hơn đáng kể và xấp xỉ bốn lần kết quả ước tính, hệ thống cảnh báo khả năng nhãn đang ghi theo đơn vị kJ thay vì kcal.
